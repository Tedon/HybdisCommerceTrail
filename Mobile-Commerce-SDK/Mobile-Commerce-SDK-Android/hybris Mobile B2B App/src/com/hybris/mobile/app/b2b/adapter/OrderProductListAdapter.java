...
public class OrderProductListAdapter extends ArrayAdapter<OrderProduct>
{
	...
	public View getView(int position, View convertView, ViewGroup parent)
	{
		...
		if (orderProduct != null)
		{
			...
			if (StringUtils.isNotBlank(orderProduct.getProduct().getImageThumbmailUrl()))
			{
				B2BApplication.getContentServiceHelper().loadImage(orderProduct.getProduct().getImageThumbmailUrl(), null,
						orderViewHolder.productImageView, 0, 0, true, null, false);
			}
