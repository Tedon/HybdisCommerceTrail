...
public final class genericShortcutChip_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	*/
	...
	final GenericShortcutChip theChip= (GenericShortcutChip) request.getAttribute(AbstractChip.CHIP_KEY);
      ...
      out.write("\r\n\t<div class=\"xp-button");
      out.print( theChip.isActive() ? " chip-event" : "-disabled" );
      out.write("\">\r\n\t\t<a href=\"#\" name=\"");
      out.print( theChip.getCommandID(GenericShortcutChip.OPEN) );
      out.write("\" style=\"width:100%;\" hidefocus=\"true\">\r\n\t\t\t<span>\r\n\t\t\t\t<table border=\"0\" cellpadding=\"0\" cellspacing=\"0\">\r\n\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t<td>\r\n\t\t\t\t\t\t\t<img class=\"icon\" src=\"images/icons/e_shortcut_");
      out.print( theChip.getUsage().equals("creator") ? "create" : "search" );
      out.write(".gif\" id=\"");
      out.print( theChip.getUniqueName() );
      out.write("_img\"/>\r\n\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t<td>\r\n\t\t\t\t\t\t\t<div class=\"label\" id=\"");
      out.print( theChip.getUniqueName() );
      out.write("_div\" >");
      out.print( localized(theChip.getName()) );
      out.write("</div>\r\n\t\t\t\t\t\t</td>\r\n\t\t\t\t\t</tr>\r\n\t\t\t\t</table>\r\n\t\t\t</span>\r\n\t\t</a>\r\n\t</div>\r\n");
