...
public final class treeViewChip_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	*/
	...
	final int boxWidth = 720 / columns;
      ...
      out.write("\r\n\t\t\t\t\t\t\t");
      out.print( model.getIconTitle(path.get(i)) );
      out.write('\r');
      out.write('\n');
						} 
      ...
      out.print(IconViewChip.AJAX_INPUT);
      out.write("\"\r\n\t\t\t\t\t\t\t\t\t name=\"");
      out.print(theChip.getCommandID( IconViewChip.PATH ));
      out.write("\"\r\n\t\t\t\t\t\t\t\t\t class=\"editorform\"\r\n\t\t\t\t\t\t\t\t\t autocomplete=\"off\"\r\n\t\t\t\t\t\t\t\t\t type=\"text\"\r\n\t\t\t\t\t\t\t\t\t value=\"");
      out.print(theChip.getPathString());
      out.write("\"\r\n\t\t\t\t\t\t\t\t\t size=\"130\"\r\n\t\t\t\t\t\t\t\t\t maxlenth=\"1000\" />\r\n\t\t\t\t\t\t\t<div id=\"");
      out.print(IconViewChip.AJAX_RESULT);
      out.write("\" class=\"autocomplete\"/>\r\n\t\t\t\t\t\t\t");
      out.print( theChip.getAutoCompleter().render() );
      out.write("\r\n\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t<td width=\"100%\" style=\"vertical-align:middle\">\r\n\t\t\t\t\t\t\t<div class=\"button-on-white chip-event\">\r\n\t\t\t\t\t\t\t\t<a href=\"#\"\r\n\t\t\t\t\t\t\t\t\tname=\"");
      out.print( theChip.getCommandID(IconViewChip.GOTO) );
      out.write("\" \r\n\t\t\t\t\t\t\t\t\ttitle=\"");
      out.print( localized("open") );
