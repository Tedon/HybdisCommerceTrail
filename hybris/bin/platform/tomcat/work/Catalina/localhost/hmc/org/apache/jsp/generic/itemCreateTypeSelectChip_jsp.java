...
public final class itemCreateTypeSelectChip_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/generic/../xp_button.inc", Long.valueOf(1427445216000L));
 ...
 if( DEBUG_COMMENTS ) { 
	...
	ItemCreateTypeSelectChip theChip = (ItemCreateTypeSelectChip) request.getAttribute(AbstractChip.CHIP_KEY);
      ...
      out.print( localized("organizer.create.info") );
      out.write(":\r\n\t\t\t</td>\r\n\t\t</tr>\r\n\t\t<tr>\r\n");
      ...
      out.write(":\r\n\t\t\t\t\t</div>\r\n\t\t\t\t</td>\r\n\t\t\t\t<td style=\"ictscDescr\">\r\n\t\t\t\t\t<select name=\"");
      out.print(theChip.getEventID(ItemCreateTypeSelectChip.TYPECODE));
      out.write("\" onchange=\"setScrollAndSubmit();\" size=\"");
      out.print( types.size() > 10 ? 10 : types.size() );
      out.write("\">\r\n");
      ...
      out.write("\r\n\t\t\t\t\t\t\t<option \r\n\t\t\t\t\t\t\t\tvalue=\"");
      out.print( entry.getCode() );
      out.write('"');
      out.write(' ');
      out.print( entry.getCode().equals(currentCode) ? " selected" : "" );
      out.write("\r\n\t\t\t\t\t\t\t\t");
      out.print( (entry.isAbstract() || entry.getType() instanceof ViewType) ? " class=\"disabled\"" : "" );
      out.write(" \r\n\t\t\t\t\t\t\t>\r\n\t\t\t\t\t\t\t\t");
      out.print( entry.getDisplayName() + description );
      out.write("\r\n\t\t\t\t\t\t\t</option>\r\n");
      ...
      out.write("\r\n\t\t\t\t\t");
      out.print( xpButtonDisabled(localized("create"), localized("create") ) );
      out.write("\t\t\t\t\r\n");
      ...
      out.write("\r\n\t\t\t\t\t");
      out.print( xpButton( localized("create"), theChip.getCommandID(ItemCreateTypeSelectChip.CREATE), localized("create") ) );
      out.write('\r');
      out.write('\n');
