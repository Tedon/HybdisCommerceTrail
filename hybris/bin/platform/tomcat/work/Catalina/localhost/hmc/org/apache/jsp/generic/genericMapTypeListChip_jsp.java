...
public final class genericMapTypeListChip_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	*/
	...
	if( (!theChip.isEditable()) && theChip.getListEntries().isEmpty() )
	{
      ...
      out.write("\r\n\t\t\t<table class=\"genericMapTypeListChip\" style=\"width:");
      out.print( theChip.getWidth() );
      out.write("px;\" cellspacing=\"0\" cellpadding=\"0\" oncontextmenu=\"");
      out.print( contextMenu );
      out.write("\">\r\n\t\t\t\t<tr>\r\n\t\t\t\t\t<td>\r\n\t\t\t\t\t\t<div class=\"gmtlcResultList\" ");
      out.print(((showScrollbars && theChip.restrictHeight() && theChip.getListEntryCount()>12)?" style=\"height:300px\"":""));
      ...
      out.write("\r\n\t\t\t\t\t\t\t\t\t<th class=\"gmtlcEntry\" colspan=\"2\" style=\"width:");
      out.print( keyWidth );
      out.write("px;\">\r\n\t\t\t\t\t\t\t\t\t\t<div class=\"gmtlcEntry\" style=\"width:");
      out.print( keyWidth );
      out.write("px;\">\r\n\t\t\t\t\t\t\t\t\t\t\t");
      out.print( localized(theChip.getKeyName()) );
      out.write("\r\n\t\t\t\t\t\t\t\t\t\t</div>\r\n\t\t\t\t\t\t\t\t\t</th>\r\n\t\t\t\t\t\t\t\t\t<th class=\"gmtlcEntry2\">\r\n\t\t\t\t\t\t\t\t\t\t<div class=\"gmtlcEntry\">\r\n\t\t\t\t\t\t\t\t\t\t\t");
      out.print( localized(theChip.getValueName()) );
      out.write("\r\n\t\t\t\t\t\t\t\t\t\t</div>\r\n\t\t\t\t\t\t\t\t\t</th>\r\n\t\t\t\t\t\t\t\t</tr>\r\n");
      ...
      out.write("\r\n\t\t\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t\t\t<td class=\"gmtlcCheckbox\">\r\n\t\t\t\t\t\t\t\t\t\t<div class=\"gmtlcCheckbox\"> </div>\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t\t<td class=\"gmtlcEntry\" colspan=\"2\" style=\"width:");
      out.print( keyWidth );
      out.write("px;\">\r\n\t\t\t\t\t\t\t\t\t\t<div class=\"gmtlcEntry\" style=\"width:");
      out.print( keyWidth );
      out.write("px;\">\r\n\t\t\t\t\t\t\t\t\t\t\t");
 theChip.getKeyEditor().render(pageContext); 
      out.write("\r\n\t\t\t\t\t\t\t\t\t\t</div>\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t\t<td class=\"gmtlcEntry2\" style=\"width:");
      out.print( valueWidth );
      out.write("px;\">\r\n\t\t\t\t\t\t\t\t\t\t<div class=\"gmtlcEntry2\" style=\"width:");
      out.print( valueWidth );
      out.write("px;\">\r\n\t\t\t\t\t\t\t\t\t\t\t");
