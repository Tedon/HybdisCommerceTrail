...
import de.hybris.platform.lucenesearch.hmc.*;

public final class LucenesearchToolbarActionChip_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	*/
	...
	if( theChip.showLabel() )
	{
      ...
      out.write("\r\n\t\t<td style=\"padding-right:5px; vertical-align:middle;\" title=\"");
      out.print( tooltip );
      out.write("\">\r\n\t\t\t");
      out.print( label.length()==0?label:label+":" );
      out.write("\r\n\t\t</td>\r\n");
      ...
      out.print( tooltip );
      out.write("\">\r\n\t<input name=\"");
      out.print( patternEvent );
      out.write("\" \r\n\t\t\ttype=\"text\" class=\"editorform\" size=\"");
      out.print(theChip.getSize());
      out.write("\" \r\n\t\t\tvalue=\"");
      out.print( HMCHelper.getXSSFilter("img").filter( theChip.getValue() ));
      out.write('"');
      out.write(' ');
      out.print( (isEnabled ? "" : "readonly=\"readonly\"") );
      out.write("\r\n\t\t\tonkeypress=\"if(isEnter(event)) { document.editorForm.elements['");
      out.print( startEvent );
      out.write("'].value = ");
