 ...
 * Generated at: 2015-11-04 09:30:56 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.ext.cronjob;
...
import de.hybris.platform.cronjob.hmc.*;

public final class triggerTimeValuesEditorChip_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/ext/cronjob/../../head.inc", Long.valueOf(1427445216000L));
    _jspx_dependants.put("/ext/cronjob/../../xp_button.inc", Long.valueOf(1427445216000L));
  }
 ...
 if( DEBUG_COMMENTS ) { 
	...
	TriggerValuesHolder triggerValues = theChip.getTriggerValues();
      ...
      out.print( localized("section.trigger.interval") );
      out.write("</div>\r\n\t\t</td>\r\n\t</tr>\r\n\r\n<!-- interval settings -->\r\n");
	...
	String intervalID = theChip.getEventID(TriggerTimeValuesEditorChip.SET_INTERVAL);
      ...
      out.print( localized("trigger.interval") );
      out.write(":</td>\r\n\t\t\t \t\t<td class=\"localAndChangedSign\">&nbsp;</td>\r\n\t\t\t\t\t<td>\r\n\t\t\t\t\t\t<table class=\"ttvecIntervals\" cellpadding=0\" cellspacing=\"0\">\r\n\t\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t\t<td>\r\n\t\t\t\t\t\t\t\t\t<input type=\"hidden\" name=\"");
      out.print( intervalID );
      out.write("\" value=\"");
      out.print( triggerValues.getSelectedInterval() );
      out.write("\" />\r\n\t\t\t\t\t\t\t\t\t<input type=\"radio\" name=\"");
      out.print( TriggerTimeValuesEditorChip.SET_INTERVAL );
      out.write("\"\r\n\t\t\t\t\t\t\t\t\t\t\t ");
      out.print( triggerValues.isSelectedInterval(TriggerTimeValuesEditorChip.INTERVAL_DAILY) ? "checked=\"checked\""
											 	  : "onclick=\"document.editorForm.elements['" + intervalID + "'].value='" + TriggerTimeValuesEditorChip.INTERVAL_DAILY + "';setScrollAndSubmit();\"" );
      out.write(" />\r\n\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t<td>\r\n\t\t\t\t\t\t\t\t\t");
      out.print( localized("trigger.interval.daily") );
      out.write("\r\n\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t\t<td>\r\n\t\t\t\t\t\t\t\t\t<input type=\"radio\" name=\"");
      out.print( TriggerTimeValuesEditorChip.SET_INTERVAL );
      out.write("\"\r\n\t\t\t\t\t\t\t\t\t\t\t ");
      out.print( triggerValues.isSelectedInterval(TriggerTimeValuesEditorChip.INTERVAL_WEEKLY) ? "checked=\"checked\""
											 	  : "onclick=\"document.editorForm.elements['" + intervalID + "'].value='" + TriggerTimeValuesEditorChip.INTERVAL_WEEKLY + "';setScrollAndSubmit();\"" );
      out.write(" />\r\n\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t<td>\r\n\t\t\t\t\t\t\t\t\t");
      out.print( localized("trigger.interval.weekly") );
      out.write("\r\n\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t\t<td>\r\n\t\t\t\t\t\t\t\t\t<input type=\"radio\" name=\"");
      out.print( TriggerTimeValuesEditorChip.SET_INTERVAL );
      out.write("\"\r\n\t\t\t\t\t\t\t\t\t\t\t ");
      out.print( triggerValues.isSelectedInterval(TriggerTimeValuesEditorChip.INTERVAL_MONTHLY) ? "checked=\"checked\""
											 	  : "onclick=\"document.editorForm.elements['" + intervalID + "'].value='" + TriggerTimeValuesEditorChip.INTERVAL_MONTHLY + "';setScrollAndSubmit();\"" );
      out.write(" />\r\n\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t<td>\r\n\t\t\t\t\t\t\t\t\t");
      out.print( localized("trigger.interval.monthly") );
      out.write("\r\n\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t\t<td>\r\n\t\t\t\t\t\t\t\t\t<input type=\"radio\" name=\"");
      out.print( TriggerTimeValuesEditorChip.SET_INTERVAL );
      out.write("\"\r\n\t\t\t\t\t\t\t\t\t\t\t ");
      out.print( triggerValues.isSelectedInterval(TriggerTimeValuesEditorChip.INTERVAL_ONCE) ? "checked=\"checked\""
											 	  : "onclick=\"document.editorForm.elements['" + intervalID + "'].value='" + TriggerTimeValuesEditorChip.INTERVAL_ONCE + "';setScrollAndSubmit();\"" );
      out.write(" />\r\n\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t<td>\r\n\t\t\t\t\t\t\t\t\t");
      out.print( localized("trigger.interval.once") );
      out.write("\r\n\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t\t<td>\r\n\t\t\t\t\t\t\t\t\t<input type=\"radio\" name=\"");
      out.print( TriggerTimeValuesEditorChip.SET_INTERVAL );
      out.write("\"\r\n\t\t\t\t\t\t\t\t\t\t\t ");
      out.print( triggerValues.isSelectedInterval(TriggerTimeValuesEditorChip.INTERVAL_FREE) ? "checked=\"checked\""
											 	  : "onclick=\"document.editorForm.elements['" + intervalID + "'].value='" + TriggerTimeValuesEditorChip.INTERVAL_FREE + "';setScrollAndSubmit();\"" );
      out.write(" />\r\n\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t<td>\r\n\t\t\t\t\t\t\t\t\t");
      out.print( localized("trigger.interval.free") );
      out.write("\r\n\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t\t<td>\r\n\t\t\t\t\t\t\t\t\t<input type=\"radio\" name=\"");
      out.print( TriggerTimeValuesEditorChip.CRON_EXPRESSION );
      out.write("\"\r\n\t\t\t\t\t\t\t\t\t\t\t ");
      out.print( triggerValues.isSelectedInterval(TriggerTimeValuesEditorChip.CRON_EXPRESSION) ? "checked=\"checked\""
											 	  : "onclick=\"document.editorForm.elements['" + intervalID + "'].value='" + TriggerTimeValuesEditorChip.CRON_EXPRESSION + "';setScrollAndSubmit();\"" );
      out.write(" />\r\n\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t<td>\r\n\t\t\t\t\t\t\t\t\t");
      out.print( localized("trigger.interval.cronexpression") );
      out.write("\r\n\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t</table>\r\n\t\t\t\t\t</td>\r\n\t\t\t\t</tr>\r\n\t\t\t</table>\r\n\t\t</td>\r\n\t</tr>\r\n\r\n\t<tr>\r\n\t\t<td class=\"sectionheader\" colspan=\"2\">\r\n\t\t\t<div class=\"sh\">");
      out.print( localized("section.trigger.details") );
      out.write("</div>\r\n\t\t</td>\r\n\t</tr>\r\n\r\n\r\n<!-- next activation time -->\r\n\t<tr class=\"spacerTR\">\r\n\t\t<td><img width=\"10\" height=\"1\" src=\"images/transparent.gif\" /></td>\r\n\t\t<td>\r\n\t\t\t<table cellspacing=\"0\" cellpadding=\"0\">\r\n\t\t\t\t<tr class=\"disabled\">\r\n\t\t\t\t\t<td width=\"arrowButton\">&nbsp;</td>\r\n\t\t\t \t\t<td class=\"label\">");
      out.print( localized("trigger.activationtime") );
      out.write(":</td>\r\n\t\t\t \t\t<td class=\"localAndChangedSign\">&nbsp;</td>\r\n\t\t\t\t\t<td>\r\n\t\t\t\t\t\t");
      out.print( theChip.getActivationTimeAsString() );
      out.write("\r\n\t\t\t\t\t</td>\r\n\t\t\t\t</tr>\r\n\t\t\t</table>\r\n\t\t</td>\r\n\t</tr>\r\n\r\n\r\n");

if( !triggerValues.getSelectedInterval().equals(TriggerTimeValuesEditorChip.CRON_EXPRESSION)) {

      out.write("\r\n<!-- start time & date-->\r\n\t<tr class=\"spacerTR\">\r\n\t\t<td><img width=\"10\" height=\"1\" src=\"images/transparent.gif\" /></td>\r\n\t\t<td>\r\n\t\t\t<table cellspacing=\"0\" cellpadding=\"0\">\r\n\t\t\t\t<tr>\r\n\t\t\t\t\t<td width=\"arrowButton\">&nbsp;</td>\r\n\t\t\t \t\t<td class=\"label\">");
      out.print( localized("trigger.starttime") );
      out.write(":</td>\r\n\t\t\t \t\t<td class=\"localAndChangedSign\">&nbsp;</td>\r\n\t\t\t\t\t<td class=\"padder\">\r\n\t\t\t\t\t\t");
 theChip.getStartTimeEditorChip().render(pageContext); 
      out.write("\r\n\t\t\t\t\t</td>\r\n\t\t\t\t\t<td class=\"buttonPadder\">\r\n\t\t\t\t\t\t");
      out.print( xpButton(localized("trigger.button.currenttime"),
	...
	if( triggerValues.getSelectedInterval().equals(TriggerTimeValuesEditorChip.INTERVAL_DAILY) )
	{
      ...
      out.print( daySkipID );
      out.write("\" value=\"");
      out.print( triggerValues.getDaySkip() );
      out.write("\" />\r\n\t\t<tr>\r\n\t\t\t<td><img width=\"10\" height=\"1\" src=\"images/transparent.gif\" /></td>\r\n\t\t\t<td>\r\n\t\t\t\t<table cellspacing=\"0\" cellpadding=\"0\">\r\n\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t<td width=\"arrowButton\">&nbsp;</td>\r\n\t\t\t\t \t\t<td class=\"label\">");
      out.print( localized("trigger.frequency") );
      out.write(":</td>\r\n\t\t\t\t \t\t<td class=\"localAndChangedSign\">&nbsp;</td>\r\n\t\t\t\t\t\t<td>\r\n\t\t\t\t\t\t\t<table class=\"ttvecIntervals\" cellspacing=\"0\" cellpadding=\"0\">\r\n\t\t\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t\t\t<td>\r\n\t\t\t\t\t\t\t\t\t\t<input type=\"radio\" name=\"");
      out.print( TriggerTimeValuesEditorChip.SET_DAYSKIP );
      out.write("\"\r\n\t\t\t\t\t\t\t\t\t\t\t\t ");
      out.print( triggerValues.getDaySkip() == 1 ? "checked=\"checked\""
												 	  : "onclick=\"document.editorForm.elements['" + daySkipID + "'].value='1'; setScrollAndSubmit();\"" );
      out.write("/>\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t\t<td colspan=\"2\">\r\n\t\t\t\t\t\t\t\t\t\t");
      out.print( localized("trigger.dayskip.daily") );
      out.write("\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t\t\t<td>\r\n\t\t\t\t\t\t\t\t\t\t<input type=\"radio\" name=\"");
      out.print( TriggerTimeValuesEditorChip.SET_DAYSKIP );
      out.write("\"\r\n\t\t\t\t\t\t\t\t\t\t\t\t ");
      out.print( triggerValues.getDaySkip() != 1 ? "checked=\"checked\""
      ...
      out.write(" />\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t\t<td>\r\n\t\t\t\t\t\t\t\t\t\t");
      out.print( localized("trigger.dayskip.frequency.pre") );
      out.write("&nbsp;&nbsp;\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t\t<td>\r\n\r\n\t\t\t\t\t\t\t\t\t\t<select name=\"");
      out.print( TriggerTimeValuesEditorChip.SET_DAYSKIP + "_select" );
      out.write("\" size=\"1\"\r\n\t\t\t\t\t\t\t\t\t\t\t\t  onchange=\"document.editorForm.elements['");
      out.print( daySkipID );
      out.write("'].value=this.value\"\r\n\t\t\t\t\t\t\t\t\t\t\t\t  ");
      out.print( triggerValues.getDaySkip() == 1 ? " disabled" : "" );
      out.write(" >\r\n");
      ...
      out.write('"');
      out.write(' ');
      out.print( (i == triggerValues.getDaySkip() ? " selected" : "") );
      out.write('>');
      out.print( i );
      out.write("</option>\r\n");
      ...
      out.write("\r\n\t\t\t\t\t\t\t\t\t\t</select>&nbsp;\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t\t<td>\r\n\t\t\t\t\t\t\t\t\t\t");
      out.print( localized("trigger.dayskip.frequency.post") );
      out.write("\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t\t</table>\r\n\t\t\t\t\t\t</td>\r\n\t\t\t\t\t</tr>\r\n\t\t\t\t</table>\r\n\t\t\t</td>\r\n\t\t</tr>\r\n");
	...
	else if( triggerValues.getSelectedInterval().equals(TriggerTimeValuesEditorChip.INTERVAL_WEEKLY) )
	{
      ...
      out.write("\r\n<!-- interval = weekly -->\r\n<!-- week skip -->\r\n\t\t<input type=\"hidden\" name=\"");
      out.print( theChip.getEventID(TriggerTimeValuesEditorChip.PING_WEEKLY_INTERVAL) );
      out.write("\" value=\"");
      out.print( AbstractChip.TRUE );
      out.write("\" />\r\n\t\t<input type=\"hidden\" name=\"");
      out.print( weekSkipID );
      out.write("\" value=\"");
      out.print( triggerValues.getWeekSkip() );
      out.write("\" />\r\n\t\t<tr class=\"spacerTR\">\r\n\t\t\t<td><img width=\"10\" height=\"1\" src=\"images/transparent.gif\" /></td>\r\n\t\t\t<td>\r\n\t\t\t\t<table cellspacing=\"0\" cellpadding=\"0\">\r\n\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t<td width=\"arrowButton\">&nbsp;</td>\r\n\t\t\t\t \t\t<td class=\"label\">");
      out.print( localized("trigger.frequency") );
      out.write(":</td>\r\n\t\t\t\t \t\t<td class=\"localAndChangedSign\">&nbsp;</td>\r\n\t\t\t\t\t\t<td>\r\n\t\t\t\t\t\t\t<table class=\"ttvecIntervals\" cellspacing=\"0\" cellpadding=\"0\">\r\n\t\t\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t\t\t<td>\r\n\t\t\t\t\t\t\t\t\t\t<input type=\"radio\" name=\"");
      out.print( TriggerTimeValuesEditorChip.SET_WEEKSKIP + "_frequency" );
      out.write("\"\r\n\t\t\t\t\t\t\t\t\t\t\t\t ");
      out.print( triggerValues.getWeekSkip() == 1 ? "checked=\"checked\""
												 	  : "onclick=\"document.editorForm.elements['" + weekSkipID + "'].value='1'; setScrollAndSubmit();\"" );
      out.write("/>\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t\t<td colspan=\"2\">\r\n\t\t\t\t\t\t\t\t\t\t");
      out.print( localized("trigger.weekskip.weekly") );
      out.write("\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t\t\t<td>\r\n\t\t\t\t\t\t\t\t\t\t<input type=\"radio\" name=\"");
      out.print( TriggerTimeValuesEditorChip.SET_WEEKSKIP + "_frequency" );
      out.write("\"\r\n\t\t\t\t\t\t\t\t\t\t\t\t ");
      out.print( triggerValues.getWeekSkip() != 1 ? "checked=\"checked\""
      ...
      out.write(" />\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t\t<td>\r\n\t\t\t\t\t\t\t\t\t\t");
      out.print( localized("trigger.weekskip.frequency.pre") );
      out.write("&nbsp;&nbsp;\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t\t<td>\r\n\t\t\t\t\t\t\t\t\t\t<select name=\"");
      out.print( TriggerTimeValuesEditorChip.SET_WEEKSKIP + "_select" );
      out.write("\" size=\"1\"\r\n\t\t\t\t\t\t\t\t\t\t\t\t  onchange=\"document.editorForm.elements['");
      out.print( weekSkipID );
      out.write("'].value=this.value\"\r\n\t\t\t\t\t\t\t\t\t\t\t\t  ");
      out.print( triggerValues.getWeekSkip() == 1 ? " disabled" : "" );
      out.write(" >\r\n");
      ...
      out.write('"');
      out.write(' ');
      out.print( (i == triggerValues.getWeekSkip() ? " selected" : "") );
      out.write('>');
      out.print( i );
      out.write("</option>\r\n");
      ...
      out.write("\r\n\t\t\t\t\t\t\t\t\t\t</select>&nbsp;\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t\t<td>\r\n\t\t\t\t\t\t\t\t\t\t");
      out.print( localized("trigger.weekskip.frequency.post") );
      out.write("\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t\t</table>\r\n\t\t\t\t\t\t</td>\r\n\t\t\t\t\t</tr>\r\n\t\t\t\t</table>\r\n\t\t\t</td>\r\n\t\t</tr>\r\n\r\n<!-- days of week -->\r\n");

		String daysOfWeekID = theChip.getEventID(TriggerTimeValuesEditorChip.SET_DAYSOFWEEK);

      out.write("\r\n\t\t<tr>\r\n\t\t\t<td><img width=\"10\" height=\"1\" src=\"images/transparent.gif\" /></td>\r\n\t\t\t<td>\r\n\t\t\t\t<table cellspacing=\"0\" cellpadding=\"0\">\r\n\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t<td width=\"arrowButton\">&nbsp;</td>\r\n\t\t\t\t \t\t<td class=\"label\">");
      out.print( localized("trigger.daysofweek") );
      out.write(":</td>\r\n\t\t\t\t \t\t<td class=\"localAndChangedSign\">&nbsp;</td>\r\n\t\t\t\t\t\t<td>\r\n\t\t\t\t\t\t\t<table class=\"ttvecIntervals\" cellspacing=\"0\" cellpadding=\"0\">\r\n\t\t\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t\t\t<td>\r\n\t\t\t\t\t\t\t\t\t\t<input type=\"checkbox\" name=\"");
      out.print( daysOfWeekID );
      out.write("\" value=\"");
      out.print( theChip.MONDAY );
      out.write("\"\r\n\t\t\t\t\t\t\t\t\t\t\t\t ");
      out.print( triggerValues.isDaySelected(theChip.MONDAY) ? "checked=\"checked\"" : "" );
      out.write(" />\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t\t<td>\r\n\t\t\t\t\t\t\t\t\t\t");
      out.print( localized("trigger.dayofweek.monday") );
      out.write("\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t\t<td>\r\n\t\t\t\t\t\t\t\t\t\t<input type=\"checkbox\" name=\"");
      out.print( daysOfWeekID );
      out.write("\" value=\"");
      out.print( theChip.SATURDAY );
      out.write("\"\r\n\t\t\t\t\t\t\t\t\t\t\t\t ");
      out.print( triggerValues.isDaySelected(theChip.SATURDAY) ? "checked=\"checked\"" : "" );
      out.write(" />\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t\t<td>\r\n\t\t\t\t\t\t\t\t\t\t");
      out.print( localized("trigger.dayofweek.saturday") );
      out.write("\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t\t\t<td>\r\n\t\t\t\t\t\t\t\t\t\t<input type=\"checkbox\" name=\"");
      out.print( daysOfWeekID );
      out.write("\" value=\"");
      out.print( theChip.TUESDAY );
      out.write("\"\r\n\t\t\t\t\t\t\t\t\t\t\t\t ");
      out.print( triggerValues.isDaySelected(theChip.TUESDAY) ? "checked=\"checked\"" : "" );
      out.write(" />\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t\t<td>\r\n\t\t\t\t\t\t\t\t\t\t");
      out.print( localized("trigger.dayofweek.tuesday") );
      out.write("\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t\t<td>\r\n\t\t\t\t\t\t\t\t\t\t<input type=\"checkbox\" name=\"");
      out.print( daysOfWeekID );
      out.write("\" value=\"");
      out.print( theChip.SUNDAY );
      out.write("\"\r\n\t\t\t\t\t\t\t\t\t\t\t\t ");
      out.print( triggerValues.isDaySelected(theChip.SUNDAY) ? "checked=\"checked\"" : "" );
      out.write(" />\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t\t<td>\r\n\t\t\t\t\t\t\t\t\t\t");
      out.print( localized("trigger.dayofweek.sunday") );
      out.write("\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t\t\t<td>\r\n\t\t\t\t\t\t\t\t\t\t<input type=\"checkbox\" name=\"");
      out.print( daysOfWeekID );
      out.write("\" value=\"");
      out.print( theChip.WEDNESDAY );
      out.write("\"\r\n\t\t\t\t\t\t\t\t\t\t\t\t ");
      out.print( triggerValues.isDaySelected(theChip.WEDNESDAY) ? "checked=\"checked\"" : "" );
      out.write(" />\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t\t<td>\r\n\t\t\t\t\t\t\t\t\t\t");
      out.print( localized("trigger.dayofweek.wednesday") );
      out.write("\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t\t\t<td>\r\n\t\t\t\t\t\t\t\t\t\t<input type=\"checkbox\" name=\"");
      out.print( daysOfWeekID );
      out.write("\" value=\"");
      out.print( theChip.THURSDAY );
      out.write("\"\r\n\t\t\t\t\t\t\t\t\t\t\t\t ");
      out.print( triggerValues.isDaySelected(theChip.THURSDAY) ? "checked=\"checked\"" : "" );
      out.write(" />\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t\t<td>\r\n\t\t\t\t\t\t\t\t\t\t");
      out.print( localized("trigger.dayofweek.thursday") );
      out.write("\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t\t\t<td>\r\n\t\t\t\t\t\t\t\t\t\t<input type=\"checkbox\" name=\"");
      out.print( daysOfWeekID );
      out.write("\" value=\"");
      out.print( theChip.FRIDAY );
      out.write("\"\r\n\t\t\t\t\t\t\t\t\t\t\t\t ");
      out.print( triggerValues.isDaySelected(theChip.FRIDAY) ? "checked=\"checked\"" : "" );
      out.write(" />\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t\t<td>\r\n\t\t\t\t\t\t\t\t\t\t");
      out.print( localized("trigger.dayofweek.friday") );
      out.write("\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t\t</table>\r\n\t\t\t\t\t\t</td>\r\n\t\t\t\t\t</tr>\r\n\t\t\t\t</table>\r\n\t\t\t</td>\r\n\t\t</tr>\r\n");
	...
	else if( triggerValues.getSelectedInterval().equals(TriggerTimeValuesEditorChip.INTERVAL_MONTHLY) )
	{
      ...
      out.write("\r\n<!-- interval = monthly -->\r\n<!-- choose day of month -->\r\n\t\t<tr>\r\n\t\t\t<td><img width=\"10\" height=\"1\" src=\"images/transparent.gif\" /></td>\r\n\t\t\t<td>\r\n\t\t\t\t<table cellspacing=\"0\" cellpadding=\"0\">\r\n\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t<td width=\"arrowButton\">&nbsp;</td>\r\n\t\t\t\t \t\t<td class=\"label\">");
      out.print( localized("trigger.dayofmonth") );
      out.write(":</td>\r\n\t\t\t\t \t\t<td class=\"localAndChangedSign\">&nbsp;</td>\r\n\t\t\t\t\t\t<td>\r\n\t\t\t\t\t\t\t<table class=\"ttvecIntervals\" cellspacing=\"0\" cellpadding=\"0\">\r\n\t\t\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t\t\t<td class=\"padder\">\r\n\t\t\t\t\t\t\t\t\t\t");
      out.print( localized("trigger.dayofmonth.frequency.pre") );
      out.write("&nbsp;&nbsp;\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t\t<td>\r\n\r\n\t\t\t\t\t\t\t\t\t\t<select name=\"");
      out.print( dayOfMonthID );
      out.write("\" size=\"1\">\r\n");
      ...
      out.write('"');
      out.write(' ');
      out.print( (i == triggerValues.getDayOfMonth() ? " selected" : "") );
      out.write('>');
      out.print( i );
      out.write("</option>\r\n");
      ...
      out.write("\r\n\t\t\t\t\t\t\t\t\t\t</select>&nbsp;\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t\t<td>\r\n\t\t\t\t\t\t\t\t\t\t");
      out.print( localized("trigger.dayofmonth.frequency.post") );
      out.write("\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t\t</table>\r\n\t\t\t\t\t\t</td>\r\n\t\t\t\t\t</tr>\r\n\t\t\t\t</table>\r\n\t\t\t</td>\r\n\t\t</tr>\r\n");
	...
	else if( triggerValues.getSelectedInterval().equals(TriggerTimeValuesEditorChip.INTERVAL_FREE) )
	{
      ...
      out.print( localized("trigger.interval.range") );
      out.write(":</td>\r\n\t\t\t\t \t\t<td class=\"localAndChangedSign\">&nbsp;</td>\r\n\t\t\t\t\t\t<td>\r\n\t\t\t\t\t\t\t<table class=\"ttvecIntervals\" cellspacing=\"0\" cellpadding=\"0\">\r\n\t\t\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t\t\t<td class=\"padder\">\r\n\t\t\t\t\t\t\t\t\t\t<select name=\"");
      out.print( theChip.getEventID(TriggerTimeValuesEditorChip.SET_INTERVAL_SECONDS) );
      out.write("\" size=\"1\">\r\n");
      ...
      out.write('"');
      out.write(' ');
      out.print( (i == triggerValues.getIntervalSeconds() ? " selected" : "") );
      out.write('>');
      out.print( i );
      out.write("</option>\r\n");
      ...
      out.write("\r\n\t\t\t\t\t\t\t\t\t\t</select>&nbsp;\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t\t<td>\r\n\t\t\t\t\t\t\t\t\t\t");
      out.print( localized("trigger.interval.free.seconds") );
      out.write("\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t\t\t<td class=\"padder\">\r\n\t\t\t\t\t\t\t\t\t\t<select name=\"");
      out.print( theChip.getEventID(TriggerTimeValuesEditorChip.SET_INTERVAL_MINUTES) );
      out.write("\" size=\"1\">\r\n");
      ...
      out.write('"');
      out.write(' ');
      out.print( (i == triggerValues.getIntervalMinutes() ? " selected" : "") );
      out.write('>');
      out.print( i );
      out.write("</option>\r\n");
      ...
      out.write("\r\n\t\t\t\t\t\t\t\t\t\t</select>&nbsp;\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t\t<td>\r\n\t\t\t\t\t\t\t\t\t\t");
      out.print( localized("trigger.interval.free.minutes") );
      out.write("\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t\t\t<td class=\"padder\">\r\n\t\t\t\t\t\t\t\t\t\t<select name=\"");
      out.print( theChip.getEventID(TriggerTimeValuesEditorChip.SET_INTERVAL_HOURS) );
      out.write("\" size=\"1\">\r\n");
      ...
      out.write('"');
      out.write(' ');
      out.print( (i == triggerValues.getIntervalHours() ? " selected" : "") );
      out.write('>');
      out.print( i );
      out.write("</option>\r\n");
      ...
      out.write("\r\n\t\t\t\t\t\t\t\t\t\t</select>&nbsp;\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t\t<td>\r\n\t\t\t\t\t\t\t\t\t\t");
      out.print( localized("trigger.interval.free.hours") );
      out.write("\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t\t\t<td class=\"padder\">\r\n\t\t\t\t\t\t\t\t\t\t<select name=\"");
      out.print( theChip.getEventID(TriggerTimeValuesEditorChip.SET_INTERVAL_DAYS) );
      out.write("\" size=\"1\">\r\n");
      ...
      out.write('"');
      out.write(' ');
      out.print( (i == triggerValues.getIntervalDays() ? " selected" : "") );
      out.write('>');
      out.print( i );
      out.write("</option>\r\n");
      ...
      out.write("\r\n\t\t\t\t\t\t\t\t\t\t</select>&nbsp;\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t\t<td>\r\n\t\t\t\t\t\t\t\t\t\t");
      out.print( localized("trigger.interval.free.days") );
      out.write("\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t\t\t<td class=\"padder\">\r\n\t\t\t\t\t\t\t\t\t\t<select name=\"");
      out.print( theChip.getEventID(TriggerTimeValuesEditorChip.SET_INTERVAL_MONTHS) );
      out.write("\" size=\"1\">\r\n");
      ...
      out.write('"');
      out.write(' ');
      out.print( (i == triggerValues.getIntervalMonths() ? " selected" : "") );
      out.write('>');
      out.print( i );
      out.write("</option>\r\n");
      ...
      out.write("\r\n\t\t\t\t\t\t\t\t\t\t</select>&nbsp;\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t\t<td>\r\n\t\t\t\t\t\t\t\t\t\t");
      out.print( localized("trigger.interval.free.months") );
      out.write("\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t\t\t<td class=\"padder\">\r\n\t\t\t\t\t\t\t\t\t\t<select name=\"");
      out.print( theChip.getEventID(TriggerTimeValuesEditorChip.SET_INTERVAL_YEARS) );
      out.write("\" size=\"1\">\r\n");
      ...
      out.write('"');
      out.write(' ');
      out.print( (i == triggerValues.getIntervalYears() ? " selected" : "") );
      out.write('>');
      out.print( i );
      out.write("</option>\r\n");
      ...
      out.write("\r\n\t\t\t\t\t\t\t\t\t\t</select>&nbsp;\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t\t<td>\r\n\t\t\t\t\t\t\t\t\t\t");
      out.print( localized("trigger.interval.free.years") );
      out.write("\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t\t</table>\r\n\t\t\t\t\t\t</td>\r\n\t\t\t\t\t</tr>\r\n\t\t\t\t</table>\r\n\t\t\t</td>\r\n\t\t</tr>\r\n");
	...
	else if( triggerValues.getSelectedInterval().equals(TriggerTimeValuesEditorChip.CRON_EXPRESSION) )
	{
      ...
      out.write("\r\n\t\t<tr>\r\n\t\t\t<td><img width=\"10\" height=\"1\" src=\"images/transparent.gif\" /></td>\r\n\t\t\t<td>\r\n\t\t\t\t<table cellspacing=\"0\" cellpadding=\"0\">\r\n\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t<td width=\"arrowButton\">&nbsp;</td>\r\n\t\t\t\t \t\t<td class=\"label\">");
      out.print( localized("trigger.cronexpression") );
      out.write("</td>\r\n\t\t\t\t \t\t<td class=\"localAndChangedSign\">&nbsp;</td>\r\n\t\t\t\t\t\t<td>\r\n\t\t\t\t\t\t\t<table class=\"ttvecIntervals\" cellspacing=\"0\" cellpadding=\"0\">\r\n\t\t\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t\t\t<td>\r\n\t\t\t\t\t\t\t\t\t\t");
