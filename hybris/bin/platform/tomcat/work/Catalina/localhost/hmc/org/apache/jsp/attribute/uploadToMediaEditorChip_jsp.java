...
public final class uploadToMediaEditorChip_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	*/
	...
	final UploadToMediaEditorChip theChip = (UploadToMediaEditorChip) request.getAttribute(AbstractChip.CHIP_KEY);
...
//	final int widthNotEdit = theChip.getWidth();
      ...
      out.write("\r\n\t\t\t\t\t");
      out.print( localized("elementnotreadable") );
      out.write('\r');
      out.write('\n');
      ...
      out.write("\r\n\t\t\t\t\t<input type=\"text\" \r\n\t\t\t\t\t\t\tstyle=\"width:100%;\"\r\n\t\t\t\t\t\t\t class=\"");
      out.print( isEditable ? "enabled" : "disabled" );
      out.write("\"\r\n\t\t\t\t\t\t\t id=\"");
      out.print( theChip.getInputID() );
      out.write("\" \r\n\t\t\t\t\t\t\t ");
      out.print( isEditable ? "" : "readonly=\"readonly\"" );
      out.write("\r\n \t\t\t\t\t\t\t value=\"");
      out.print( theChip.getDisplayValue() );
      out.write("\"/>\r\n");
...
/*
      ...
      out.write("\" class=\"autocomplete\"></div>\r\n");
...
*/
      ...
      out.write("\r\n\t\t\t\t<td style=\"width:");
      out.print( widthSearchButt );
      out.write("px;\">\r\n\t\t\t\t\t<div class=\"button-on-white chip-event\" style=\"width:");
      out.print( widthSearchButt );
      out.write("px;\">\r\n\t\t\t\t\t\t<a href=\"#\" style=\"width:");
      out.print( widthSearchButt );
      out.write("px\" title=\"");
      out.print( localized("clicktoopensearch") );
      out.write("\" name=\"");
      out.print( theChip.getEventID( ReferenceAttributeEditorChip.OPEN_SEARCH ) );
      out.write("\" hidefocus=\"true\">\r\n\t\t\t\t\t\t\t<span>\r\n\t\t\t\t\t\t\t\t<img class=\"icon\" src=\"images/icons/valueeditor_search.gif\" id=\"");
      out.print( theChip.getUniqueName() );
      out.write("_img\"/>\r\n\t\t\t\t\t\t\t</span>\r\n\t\t\t\t\t\t</a>\r\n\t\t\t\t\t</div>\r\n\t\t\t\t</td>\r\n");

			}
		
			if( isEditable && theChip.canUpload()  )
			{
      ...
      out.write("\" hidefocus=\"true\"\r\n\t\t\t\t\t\t\tname=\"");
      out.print( theChip.getCommandID(UploadToMediaEditorChip.UPLOAD) );
      out.write("\">\r\n\t\t\t\t\t\t\t<span id=\"");
      out.print( theChip.getUniqueName() );
      out.write("_uploadspan\">\r\n\t\t\t\t\t\t\t\t<img class=\"icon\" src=\"images/icons/valueeditor_upload.gif\" id=\"");
      out.print( theChip.getUniqueName() );
      out.write("_uploading\"/>\r\n\t\t\t\t\t\t\t</span>\r\n\t\t\t\t\t\t</a>\r\n\t\t\t\t\t</div>\r\n\t\t\t\t</td>\r\n");

			}
			
			if( !isEditable && theChip.getValue() != null )
			{
      ...
      out.print( widthSearchButt );
      out.write("px;\">\r\n\t\t\t\t\t\t<a href=\"");
      out.print(((Media) theChip.getValue()).getURL());
      out.write("\" title=\"");
