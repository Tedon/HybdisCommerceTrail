 ...
 */
package org.apache.jsp.ext.advancedsavedquery;

import javax.servlet.*;
import javax.servlet.http.*;
import javax.servlet.jsp.*;
import de.hybris.platform.advancedsavedquery.hmc.*;
import java.util.*;
...
import de.hybris.platform.advancedsavedquery.jalo.*;

public final class abstractGenericConditionalSearchChip_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/ext/advancedsavedquery/../../emptyFooter.inc", Long.valueOf(1427445216000L));
    _jspx_dependants.put("/ext/advancedsavedquery/../../head.inc", Long.valueOf(1427445216000L));
  }
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	*/
		 ...
		 && !((ViewType) theChip.getSearchType()).getDescription().equals("") )
	{
      ...
      out.print(((ViewType) theChip.getSearchType()).getDescription());
      out.write("\r\n\t\t\t</td>\r\n\t\t</tr>\r\n");
	...
	int span = 2;
      ...
      out.write("\r\n\t\t\t\t\t<tr class=\"row\">\r\n\t\t\t\t\t\t<th class=\"header\">\r\n\t\t\t\t\t\t\t<div class=\"header\">");
      out.print( localized("search.header.query") );
      out.write("</div>\r\n\t\t\t\t\t\t</th>\r\n\t\t\t\t\t\t<th class=\"text\" colspan=\"");
      out.print(span);
      out.write("\">\r\n");
      ...
      out.write("\t\t\t\t\r\n\t\t\t\t\t<tr class=\"row\">\r\n\t\t\t\t\t\t<th class=\"attribute\">\r\n\t\t\t\t\t\t\t<div class=\"attribute\">");
      out.print(localized("search.header.attribute"));
      out.write("</div>\r\n\t\t\t\t\t\t</th>\r\n");
      ...
      out.write("\r\n\t\t\t\t\t\t\t\t<th class=\"locale\">\r\n\t\t\t\t\t\t\t\t\t<div class=\"locale\">");
      out.print(localized("search.header.locale"));
      out.write("</div>\r\n\t\t\t\t\t\t\t\t</th>\r\n\t\t\t\t\t\t\t\t<th class=\"comparator\">\r\n\t\t\t\t\t\t\t\t\t<div class=\"comparator\">");
      out.print(localized("search.header.comparator"));
      out.write("</div>\r\n\t\t\t\t\t\t\t\t</th>\r\n");
      ...
      out.write("\r\n\t\t\t\t\t\t<th class=\"condition\">\r\n\t\t\t\t\t\t\t<div class=\"condition\">");
      out.print(localized("search.header.condition"));
      out.write("</div>\r\n\t\t\t\t\t\t</th>\r\n\t\t\t\t\t</tr>\r\n");
      ...
      out.print( localized("search.button") );
      out.write("\" name=\"");
      out.print( theChip.getCommandID(AbstractGenericConditionalSearchChip.SEARCH) );
      out.write("\" hidefocus=\"true\">\r\n\t\t\t\t\t\t\t\t<span class=\"label\" id=\"");
      out.print( theChip.getUniqueName() );
      out.write("_searchbutton\">\r\n\t\t\t\t\t\t\t\t\t");
      out.print( localized("search.button") );
      ...
      out.print( theChip.getEventID(AbstractGenericConditionalSearchChip.INCLUDE_SUBTYPES) );
      out.write("\" \r\n\t\t\t\t\t\t\t\t\t value=\"");
      out.print( theChip.isIncludeSubtypes() );
      out.write("\"\r\n\t\t\t\t\t\t\t/>\r\n\t\t\t\t\t\t\t<input type=\"checkbox\" ");
      out.print( theChip.isIncludeSubtypes() ? "checked" : "" );
      out.write(" \r\n\t\t\t\t\t\t\t\t\t id=\"");
      out.print( theChip.getUniqueName() );
      out.write("_subtypebox\"\r\n\t\t\t\t\t\t\t\t\t onclick=\"document.editorForm.elements['");
      out.print( theChip.getEventID(AbstractGenericConditionalSearchChip.INCLUDE_SUBTYPES) );
      out.write("'].value='");
      out.print( !theChip.isIncludeSubtypes());
      out.write("';\"\r\n\t\t\t\t\t\t\t\t\t ");
      out.print( theChip.getSearchType().isAbstract() ? " disabled" : "" );
      out.write("\r\n\t\t\t\t\t\t\t/>\r\n\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t<td>\r\n\t\t\t\t\t\t\t");
      out.print( localized("search.include.subtypes") );
      out.write("\r\n\t\t\t\t\t\t</td>\r\n");
