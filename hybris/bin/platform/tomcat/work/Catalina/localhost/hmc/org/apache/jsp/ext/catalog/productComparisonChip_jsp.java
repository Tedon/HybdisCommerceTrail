...
import de.hybris.platform.catalog.hmc.ProductComparisonChip;

public final class productComparisonChip_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	*/
	...
	String backgroundColor;
      ...
      out.write("\r\n\t\t\t<th>\r\n\t\t\t\t<div>\r\n\t\t\t\t\t<a href=\"#\" \r\n\t\t\t\t\t\tonclick=\"setEvent('");
      out.print( theChip.getCommandID(ProductComparisonChip.OPEN_PRODUCT) );
      out.write("', '");
      out.print( product.getPK().toString() );
      ...
      out.write("\r\n \t</tr>\r\n \t<tr>\r\n \t\t<th>\r\n\t\t\t<div>\r\n\t\t\t\t");
      out.print( localized( "productcomparison" ) );
      out.write("\r\n\t\t\t</div>\r\n \t\t</th>\r\n");
      ...
      out.print( theChip.getCommandID(ProductComparisonChip.SET_MASTER_PRODUCT) );
      out.write("', '");
      out.print( product.getPK().toString() );
	...
	// product code
      ...
      out.write("\r\n\t\t<tr>\r\n\t\t\t<th>\r\n\t\t\t\t<div>\r\n\t\t\t\t\t");
      out.print( TypeManager.getInstance().getComposedType(Product.class).getAttributeDescriptor( "code" ).getName() );
      out.write("\r\n\t\t\t\t</div>\r\n\t\t\t</th>\r\n");
	...
	// product catalog version
      ...
      out.write("\r\n\t\t<tr>\r\n\t\t\t<th>\r\n\t\t\t\t<div>\r\n\t\t\t\t\t");
      out.print( TypeManager.getInstance().getComposedType(Product.class).getAttributeDescriptor( "catalogVersion" ).getName() );
      out.write("\r\n\t\t\t\t</div>\r\n\t\t\t</th>\r\n");
	...
	for( Product product : theChip.getProducts() )
	{
      ...
      out.print( fontcolor );
      out.write(";\">\r\n\t\t\t\t<div>\r\n\t\t\t\t\t");
      out.print( CatalogManager.getInstance().getCatalogVersion(product).getCatalog().getName() );
      out.write("\r\n\t\t\t\t\t<br>(");
      out.print( CatalogManager.getInstance().getCatalogVersion(product).getVersion() );
      out.write(")\r\n\t\t\t\t</div>\r\n\t\t\t</td>\r\n");
	...
	for( ClassAttributeAssignment assignment : theChip.getClassAssignments() )
	{
      ...
      out.write("\r\n\t\t<tr>\r\n\t\t\t<th>\r\n\t\t\t\t<div>\r\n\t\t\t\t\t");
      out.print( theChip.getAttributeName(assignment) );
      out.write("\r\n\t\t\t\t</div>\r\n\t\t\t</th>\r\n");
      ...
      out.print( fontcolor );
      out.write(";\">\r\n\t \t\t\t<div>\r\n\t \t\t\t\t");
      out.print( theChip.getValue(assignment, product) );
      out.write("\r\n\t \t\t\t</div>\r\n\t \t\t</td>\r\n");
