...
public final class itemChip_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	*/
	...
	String closeErrorMessage = isWizard ? ((GenericItemChip) theChip).getCloseErrorMessage() : "";
      ...
      out.print( isWizard && !isProcessing ? "class=\"hidden\"" : "" );
      out.write(">\r\n\t\t<td class=\"icToolbar\" style=\"");
      out.print( !theChip.isPartOf() ? "height:27px; background-color:#D3D3D8;" : "" );
      out.write('"');
      out.write('>');
 theChip.getToolbar().render(pageContext); 
      out.write("</td>\r\n\t</tr>\r\n\t<tr>\r\n\t\t<td class=\"icEditor\">");
 theChip.getEditor().render(pageContext); 
      out.write("</td>\r\n\t</tr>\r\n");
	...
	if( theChip.hasFooter() )
	{
      ...
      out.write("\r\n\t<tr>\r\n\t\t<td class=\"icFooter\">");
 theChip.getFooter().render(pageContext); 
      out.write("</td>\r\n\t</tr>\r\n");
