...
public final class StructureEditorChip_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/administration/../head.inc", Long.valueOf(1427445216000L));
  }
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	*/
	...
	final String confirmLogout = localized("structure.editor.logout.confirm");
      ...
      out.print( theChip.getTitle() );
      out.write("\r\n\t\t</td>\r\n\t</tr>\r\n\t<tr class=\"spacer\"><td>&nbsp;</td></tr>\r\n\t<tr><td>");
      out.print( localized("text.structure.editor") );
      out.write("</td></tr>\r\n\t<tr class=\"spacer\"><td>&nbsp;</td></tr>\r\n\t<tr>\r\n\t\t<td><textarea name=\"");
      out.print(theChip.getEventID(StructureEditorChip.TEXT));
      out.write("\" rows=\"35\" wrap=\"off\" id=\"");
      out.print( theChip.getUniqueName() );
      out.write("_textarea\">");
      out.print(theChip.getStructureQuoted());
      out.write("</textarea></td>\r\n\t</tr>\r\n\t<tr>\r\n\t\t<td>\r\n\t\t\t<table width=\"100%\">");

					if( !theChip.isUsingDBForStructure() )
					{

      out.write("\r\n\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t<td colspan=\"5\" class=\"notusingdb\">");
      out.print( localized("structure.editor.notusingdb.warning") );
      out.write("</td>\r\n\t\t\t\t\t\t</tr>\r\n");

					}

      out.write("\r\n\t\t\t\r\n\t\t\t\t<tr>\r\n\t\t\t\t\t<td class=\"secButtons\">\r\n\t\t\t\t\t\t<div class=\"xp-button chip-event\">\r\n\t\t\t\t\t\t\t<a href=\"#\" title=\"");
      out.print( localized("structure.editor.validate.tooltip") );
      out.write("\" name=\"");
      out.print( theChip.getCommandID(StructureEditorChip.VALIDATE) );
      out.write("\" hidefocus=\"true\">");

								if( confirmXSD != null && confirmXSD.length() > 0 )
								{
								
      out.write("<span class=\"confirm-message\">");
      out.print( confirmXSD );
      out.write("</span>");

								}
								
      out.write("<span class=\"structure_editor_hack\"></span>\r\n\t\t\t\t\t\t\t\t<span class=\"label\">\r\n\t\t\t\t\t\t\t\t\t");
      out.print( localized("structure.editor.validate.button") );
      out.write("\r\n\t\t\t\t\t\t\t\t</span>\r\n\t\t\t\t\t\t\t</a>\r\n\t\t\t\t\t\t</div>\r\n\t\t\t\t\t\t<div class=\"xp-button chip-event\">\r\n\t\t\t\t\t\t\t<a href=\"#\" title=\"");
      out.print( localized("structure.editor.uploadeditor.tooltip") );
      out.write("\" name=\"");
      out.print( theChip.getCommandID(StructureEditorChip.UPLOADEDITOR) );
      out.write("\" hidefocus=\"true\">");
      ...
      out.write("  <span class=\"confirm-message\">");
      out.print( confirmLogout );
      out.write("</span><span class=\"structure_editor_hack\"></span>\r\n\t\t\t\t\t\t\t\t<span class=\"label\">\r\n\t\t\t\t\t\t\t\t\t");
      out.print( localized("structure.editor.uploadeditor.button") );
      out.write("\r\n\t\t\t\t\t\t\t\t</span>\r\n\t\t\t\t\t\t\t</a>\r\n\t\t\t\t\t\t</div>\r\n\t\t\t\t\t\t\r\n\t\t\t\t\t\t<script language=\"JavaScript1.2\">\r\n\t\t\t\t\t\t\taddKeyFunction(\"S\", function() { if (confirm(decodeURI(\"");
      out.print( confirmLogout );
      out.write("\")) )\r\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t{ setEvent(\"");
      out.print( theChip.getCommandID(StructureEditorChip.UPLOADEDITOR) );
      out.write("\"); setScrollAndSubmit(true); } \r\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t });\r\n\t\t\t\t\t\t</script>\r\n\t\t\t\t\t\t\r\n\t\t\t\t\t\t<div class=\"xp-button chip-event\">\r\n\t\t\t\t\t\t\t<a href=\"#\" title=\"");
      out.print( localized("structure.editor.reset.tooltip") );
      out.write("\" name=\"");
      out.print( theChip.getCommandID(StructureEditorChip.RESET) );
      out.write("\" hidefocus=\"true\">\r\n\t\t\t\t\t\t\t\t<span class=\"label\">\r\n\t\t\t\t\t\t\t\t\t");
      out.print( localized("structure.editor.reset.button") );
      out.write("\r\n\t\t\t\t\t\t\t\t</span>\r\n\t\t\t\t\t\t\t</a>\r\n\t\t\t\t\t\t</div>\r\n\t\t\t\t\t\t<div class=\"xp-button chip-event\">\r\n\t\t\t\t\t\t\t<a href=\"#\" style=\"width:140px;\" title=\"");
      out.print( localized("structure.editor.uploadfile.tooltip") );
      out.write("\" name=\"");
      out.print( theChip.getCommandID(StructureEditorChip.UPLOADFILE) );
      out.write("\" hidefocus=\"true\">\r\n\t\t\t\t\t\t\t\t<span class=\"confirm-message\">");
      out.print( confirmLogout );
      out.write("</span>\r\n\t\t\t\t\t\t\t\t<span class=\"label\">\r\n\t\t\t\t\t\t\t\t\t");
      out.print( localized("structure.editor.uploadfile.button") );
      out.write("\r\n\t\t\t\t\t\t\t\t</span>\r\n\t\t\t\t\t\t\t</a>\r\n\t\t\t\t\t\t</div>\r\n\t\t\t\t</tr>\r\n\t\t\t</table>\r\n\t\t</td>\r\n\t</tr>\r\n</table>\r\n");
