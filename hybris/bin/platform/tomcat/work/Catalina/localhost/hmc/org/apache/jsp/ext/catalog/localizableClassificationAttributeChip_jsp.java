...
import de.hybris.platform.catalog.hmc.ClassificationAttributeChip;
import de.hybris.platform.catalog.hmc.AbstractClassificationAttributeEditorChip;

public final class localizableClassificationAttributeChip_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/ext/catalog/../../head.inc", Long.valueOf(1427445216000L));
  }
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	*/
	...
	else
	{
      ...
      out.write('x');
      out.write(';');
      out.print( invalidValue ? "color:red;" : "" );
      out.write("white-space:normal;");
      out.print( mandatory ? "font-weight:bold;" : "" );
      out.write("\"\r\n\t\t \t\t\t\t  class=\"chip-event\" oncontextmenu=\"");
      out.print( contextMenu );
      out.write("\" >\r\n\t\t\t\t\t\t<a href=\"#\" \r\n\t\t\t\t\t\t\ttitle=\"");
      out.print( localized("classification.editor.open.attribute") );
      out.write("\" \r\n\t\t\t\t\t\t\tname=\"");
      out.print( theChip.getCommandID(ClassificationAttributeChip.OPEN_ATTRIBUTE_EXTERNAL) );
      out.write("\"\r\n\t\t\t\t\t\t\tstyle=\"color:#333333;\">\r\n\t\t\t \t\t\t\t");
      ...
      out.print( localized("expand") );
      out.write("\" \r\n\t\t\t\t\t\t\t\t\t\t\tname=\"");
      out.print( theChip.getCommandID(ClassificationAttributeChip.EXPAND) );
      ...
      out.write("\r\n\r\n\t\t\t\t\t<!-- language code -->\r\n\t\t\t\t\t\t\t\t<td style=\"width:17px; height:20px; text-align:left;\">\r\n\t\t\t\t\t\t\t\t\t<div style=\"white-space: nowrap; width:17px; \" ");
      out.print( (editable ? "" : "class=\"disabled\"") );
      out.write(">\r\n\t\t\t\t\t\t\t\t\t\t");
      out.print( sessionLanguage.getIsoCode() );
      out.write("\r\n\t\t\t\t\t\t\t\t\t</div>\r\n\t\t\t\t\t\t\t\t</td>\r\n");
 ...
 editorChip.render(pageContext); 
      ...
      out.write("\r\n\t\t\t\t\t\t\t\t\t<tr align=\"left\">\r\n\r\n\t\t\t\t\t\t<!-- language code -->\r\n\t\t\t\t\t\t\t\t\t\t<td style=\"width:17px; height:20px; text-align:left;\">\r\n\t\t\t\t\t\t\t\t\t\t\t<div style=\"width:17px; white-space: nowrap;\" ");
      out.print( editable ? "" : "class=\"disabled\"" );
      out.write(">\r\n\t\t\t\t\t\t\t\t\t\t\t\t");
      out.print( entry.getKey().getIsoCode() );
      out.write("\r\n\t\t\t\t\t\t\t\t\t\t\t</div>\r\n\t\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t\t\t\r\n\t\t\t\t\t\t<!-- is changed sign -->\r\n\t\t\t\t\t\t\t\t \t\t<td style=\"width:10px; text-align:center;\">\r\n\t\t\t\t\t\t\t\t \t\t\t<div style=\"width:10px;\">\r\n\t\t\t\t\t\t\t\t\t\t\t\t");
      out.print( (editorChip.isChanged() ? "*" : "&nbsp;") );
      out.write("\r\n\t\t\t\t\t\t\t\t\t\t\t</div>\r\n\t\t\t\t\t\t\t\t \t\t</td>\r\n\t\t\t\t\t\t\r\n\t\t\t\t\t\t<!-- attribute editor -->\r\n\t\t\t\t\t\t\t\t\t\t<td>\r\n\t\t\t\t\t\t\t\t\t\t\t");
 editorChip.render(pageContext); 
