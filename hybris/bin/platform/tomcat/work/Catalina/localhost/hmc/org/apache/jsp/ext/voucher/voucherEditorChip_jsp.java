 ...
 */
package org.apache.jsp.ext.voucher;
...
import de.hybris.platform.voucher.hmc.VoucherEditorChip;

public final class voucherEditorChip_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/ext/voucher/../../head.inc", Long.valueOf(1427445216000L));
  }
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	*/
	...
	boolean active = theChip.isActive();
      ...
      out.print(theChip.getEventID(VoucherEditorChip.VOUCHERCODE));
      out.write("\" id=\"");
      out.print( theChip.getUniqueName() );
      out.write("_input\" ");
      out.print( (active ? "" : "disabled"));
      out.write(">&nbsp;\n\t\t\t\t\t</td>\n\t\t\t\t\t<td>&nbsp;</td>\n\t\t\t\t\t<td>\n\t\t\t\t\t\t<div class=\"xp-button");
      out.print( active ? " chip-event" : "-disabled" );
      out.write("\">\n\t\t\t\t\t\t\t<a style=\"width:130px;\" href=\"#\" title=\"");
      out.print( localized("btn.redeem.voucher") );
      out.write("\" name=\"");
      out.print( theChip.getEventID(VoucherEditorChip.REDEEM) );
      ...
      out.print( active ? " chip-event" : "-disabled" );
      out.write("\">\n\t\t\t\t\t\t\t<a style=\"width:130px;\" href=\"#\" title=\"");
      out.print( localized("btn.release.voucher") );
      out.write("\" name=\"");
      out.print( theChip.getEventID(VoucherEditorChip.RELEASE) );
      out.write("\" hidefocus=\"true\">\n\t\t\t\t\t\t\t\t<span>\n\t\t\t\t\t\t\t\t\t<span class=\"label\" id=\"");
      out.print( theChip.getUniqueName() );
      out.write("_release\">\n\t\t\t\t\t\t\t\t\t\t");
      out.print( localized("btn.release.voucher") );
	...
	{ 
      ...
      out.print( localized( "voucher.assigned" ) );
      out.write(":\n\t\t   </div>\n\t\t</td>\n\t\t<td width=\"30px\">&nbsp;</td>\n\t\t<td>");
 theChip.getDiscountList().render(pageContext); 
      out.write("</td>\n\t</tr>\n");
