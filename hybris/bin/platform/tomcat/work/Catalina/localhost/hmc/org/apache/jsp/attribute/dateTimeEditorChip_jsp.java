...
public final class dateTimeEditorChip_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	*/
	...
	else
	{
      ...
      out.write("px;\">\r\n\t<table class=\"dateTimeEditorChip\" style=\"width:");
      out.print( theChip.getWidth() );
      out.write("px;\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\">\r\n\t\t<tr>\r\n\t\t\t<!-- date input field -->\r\n\t\t\t<td style=\"width:");
      out.print( theChip.getDateWidth() );
      out.write("px;\"\r\n\t\t\t\t class=\"dateInputField\"\r\n\t\t\t\t title=\"");
      out.print(theChip.getScriptDateFormat());
      out.write("\">\r\n\t\t\t\t<input type=\"input\" name=\"");
      out.print( eventID );
      out.write("\"\r\n\t\t\t\t\tclass=\"");
      out.print( isEditable ? "enabled" : "disabled" );
      out.write("\"\r\n\t\t\t\t\tvalue=\"");
      out.print(theChip.getStringDateValue());
      out.write("\"\r\n\t\t\t\t\tstyle=\"width:");
      out.print( theChip.getDateWidth() );
      out.write("px;\"\r\n\t\t\t\t\tid=\"");
      ...
      out.write("\r\n\t\t\t\t\t<div class=\"button-on-white datePickerSymbol\">\r\n \t\t\t\t\t\t<a href=\"#\"\r\n \t\t\t\t\t\t\tonclick=\"(new calendar(document.editorForm.elements['");
      out.print( eventID );
      out.write("'], '");
      out.print( localized("datepicker") );
      out.write("', '");
      out.print( localized("datepicker.header") );
      out.write("', '");
      out.print( theChip.getDatePattern() );
      out.write('\'');
      out.write(',');
      out.write(' ');
      out.print( HMCHelper.getLocalizedMonths() );
      out.write(',');
      out.write(' ');
      out.print( HMCHelper.getLocalizedWeekdays() );
      out.write(")).popup();\"\r\n\t\t\t\t\t\t\thidefocus=\"true\" title=\"");
      out.print( localized("datepicker") );
      out.write("\">\r\n\t\t\t\t\t\t   <span>\r\n\t\t\t\t\t\t\t\t<img class=\"icon\" id=\"");
      out.print( theChip.getUniqueName() );
      out.write("_img\" src=\"images/icons/calendar.gif\"/>\r\n\t\t\t\t\t\t\t</span>\r\n\t\t\t\t\t\t</a>\r\n\t\t\t\t\t</div>\r\n\r\n");
      ...
      out.write("\r\n\t\t\t<!-- time input field -->\r\n\t\t\t<td style=\"width:");
      out.print( theChip.getTimeWidth() );
      out.write("px;\"\r\n\t\t\t\t class=\"timeInputField\"\r\n\t\t\t\t title=\"");
      out.print(theChip.getScriptTimeFormat());
      out.write("\">\r\n\t\t\t\t<input type=\"input\" name=\"");
      out.print(theChip.getEventID(DateTimeEditorChip.SET_TIME_VALUE));
      out.write("\"\r\n\t\t\t\t\tclass=\"");
      out.print( isEditable ? "enabled" : "disabled" );
      out.write("\"\r\n\t\t\t\t\tvalue=\"");
      out.print(theChip.getStringTimeValue());
      out.write("\"\r\n\t\t\t\t\tstyle=\"width:");
      out.print( theChip.getTimeWidth() );
      out.write("px\"\r\n\t\t\t\t\tid=\"");
      out.print( theChip.getUniqueName() );
