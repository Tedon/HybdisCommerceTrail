...
import de.hybris.platform.print.jalo.ContentBlock;
import de.hybris.platform.print.hmc.attribute.StyleWysiwygEditorChip;

public final class styleWysiwygEditorChip_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/ext/print/../../head.inc", Long.valueOf(1427445216000L));
  }
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	*/
	...
	final boolean isEditable = theChip.isEditable();
      ...
      out.write("px\">\r\n\t\t\t\t\t\t\t");
      out.print( theChip.getValue() == null ? "" : theChip.getValue() );
      ...
      out.write("\t\t\t\t\textended_valid_elements : \"a[name|href|target|title|onclick],img[class|src|border=0|alt|title|hspace|vspace|width|height|align|onmouseover|onmouseout|name],hr[class|width|size|noshade],font[face|size|color|style],span[class|align|style],style[*]\",\r\n\t\t\t\t\thybris_anyitemlink_enabled: ");
      out.print( hasClipboardItem );
      out.write(",\r\n\t\t\t\t\thybris_anyitemlink: \"");
      out.print( itemURL );
      out.write("\",\r\n\t\t\t\t\thybris_medialink_enabled: ");
      out.print( hasMediaLink );
      out.write(",\r\n\t\t\t\t\thybris_medialink: \"");
      out.print( mediaURL );
      out.write("\",\r\n\t\t\t\t\thybris_print_characterstyles : \"");
      out.print( cStyles );
      out.write("\", \r\n\t\t\t\t\thybris_print_paragraphstyles : \"");
      out.print( pStyles );
      out.write("\",\r\n\t\t\t\t\tlanguage : \"");
      out.print( language );
      out.write("\",\r\n\t\t\t\t\tonchange_callback : \"mce_myOnChangeHandler\",\r\n\t\t\t\t\texeccommand_callback : \"mce_myExecCommandHandler\",\r\n\t\t\t        table_styles : \"");
      out.print(theChip.getTableStyles() );
      out.write("\",\r\n\t\t\t    \ttable_cell_styles : \"");
      out.print(theChip.getTableCellStyles() );
      out.write("\"\r\n\t\t\t\t\t\r\n\t\t\t\t});\r\n\r\n\t\t\t\ttinyMCE.addI18n({");
      out.print( language );
      out.write(":{\r\n\t\t\t\t\thybris:{\r\n\t\t\t\t\t\tanyitemlink_title : '");
      out.print( localized("anyitemlink.title") );
      out.write("',\r\n\t\t\t\t\t\tmedialink_title : '");
      out.print( localized("medialink.title") );
      out.write("'\r\n\t\t\t\t}}});\r\n\t\t\t\ttinyMCE.addI18n({");
      out.print( language );
      out.write(":{\r\n\t\t\t\t\thybrisstyles:{\r\n\t\t\t\t\t\temptycharacterstyle : '");
      out.print( localized("text.wysiwygeditor.emptycharacterstyle") );
      out.write("',\r\n\t\t\t\t\t\temptyparagraphstyle : '");
      out.print( localized("text.wysiwygeditor.emptyparagraphstyle") );
      out.write("'\r\n\t\t\t\t}}});\r\n\r\n\t\t\t\tmce_addIsChangedElement('");
      out.print( valueEventID );
      out.write("', $('");
      out.print( isChangedEventID );
      out.write("_id'));\r\n\t\t\t\t\r\n\t\t\t</script>\r\n");
      ...
      out.write("_textarea\">");
      out.print( theChip.getDisplayContent() );
      out.write("</textarea>\r\n\t\t\t<iframe style=\"width:");
      out.print( theChip.getWidth() );
      out.write("px; height:");
      out.print( theChip.getHeight() );
