...
public final class typeExportContentChip_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	*/
	...
	TypeExportContentChip theChip = (TypeExportContentChip)request.getAttribute( AbstractChip.CHIP_KEY );
      ...
      out.write("\r\n\t\t</td>\r\n\t</tr>\r\n\t<tr class=\"header\">\r\n\t\t<td colspan=\"2\">\r\n\t\t\t");
      out.print(localized("typeexport.header"));
      out.write("\r\n\t\t</td>\r\n\t</tr>\r\n\t<tr class=\"list\">\r\n\t\t<td>\r\n\t\t\t");
 theChip.getListEditor().render(pageContext); 
      out.write("\r\n\t\t</td>\r\n\t\t<td class=\"list\">\r\n\t\t\t<table>\r\n\t\t\t\t<tr>\r\n\t\t\t\t\t<td>\r\n\t\t\t\t\t\t<div class=\"xp-button chip-event\">\r\n\t\t\t\t\t\t\t<a href=\"#\" class=\"typeDefinition\" \ttitle=\"");
      out.print( localized("typeexport.export.tooltip") );
      out.write("\" name=\"");
      out.print( theChip.getCommandID(TypeExportContentChip.EXPORT_TYPES) );
      out.write("\" hidefocus=\"true\">\r\n\t\t\t\t\t\t\t\t<span class=\"label\">\r\n\t\t\t\t\t\t\t\t\t");
      out.print( localized("typeexport.export.button") );
      out.write("\r\n\t\t\t\t\t\t\t\t</span>\r\n\t\t\t\t\t\t\t</a>\r\n\t\t\t\t\t\t</div>\r\n\t\t\t\t\t</td>\r\n\t\t\t\t</tr>\r\n\t\t\t\t<tr>\r\n\t\t\t\t\t<td>\r\n\t\t\t\t\t\t<i>");
      out.print( localized("typeexport.export.info") );
      out.write("</i>\r\n\t\t\t\t\t</td>\r\n\t\t\t\t</tr>\r\n\t\t\t\t<tr>\r\n\t\t\t\t\t<td class=\"typeLocalisation\">\r\n\t\t\t\t\t\t<div class=\"xp-button chip-event\">\r\n\t\t\t\t\t\t\t<a href=\"#\" title=\"");
      out.print( localized("typeexport.localization.tooltip") );
      out.write("\" name=\"");
      out.print( theChip.getCommandID(TypeExportContentChip.EXPORT_TYPE_LOCALIZATION) );
      out.write("\" hidefocus=\"true\">\r\n\t\t\t\t\t\t\t\t<span class=\"label\">\r\n\t\t\t\t\t\t\t\t\t");
      out.print( localized("typeexport.localization.button") );
      out.write("\r\n\t\t\t\t\t\t\t\t</span>\r\n\t\t\t\t\t\t\t</a>\r\n\t\t\t\t\t\t</div>\r\n\t\t\t\t\t</td>\r\n\t\t\t\t</tr>\r\n\t\t\t\t<tr>\r\n\t\t\t\t\t<td>\r\n\t\t\t\t\t\t<i>");
      out.print( localized("typeexport.localization.info") );
      out.write("</i>\r\n\t\t\t\t\t</td>\r\n\t\t\t\t</tr>\r\n\t\t\t</table>\r\n\t\t</td>\r\n\t</tr>\r\n</table>\r\n");
