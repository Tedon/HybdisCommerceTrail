...
import de.hybris.platform.impex.hmc.export.*;

public final class radioButtonEditorChip_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/ext/impex/../../head.inc", Long.valueOf(1427445216000L));
  }
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	*/
	...
	while(iter.hasNext()){
      ...
      out.write("\r\n\t<tr>\r\n\t\t<td>\r\n\t\t\t<input type=\"radio\" ");
      out.print( checked ? "checked=\"checked\"" : "" );
      out.write(" name=\"");
      out.print( name );
      out.write("\" id=\"");
      out.print( theChip.getID()+"_"+key );
      out.write("\" value=\"");
      out.print(key);
      out.write("\"/>\r\n\t\t</td>\r\n\t\t<td onclick=\"document.getElementById('");
      out.print( theChip.getID() + "_" + key );
      out.write("').checked = true;\">\r\n\t\t\t");
      out.print(localized( value ));
      out.write("\r\n\t\t</td>\r\n\t</tr>\r\n\t");
