...
public final class organizerCreateChip_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/generic/organizer/../../xp_button.inc", Long.valueOf(1427445216000L));
 ...
 if( DEBUG_COMMENTS ) { 
	...
	OrganizerCreateChip theChip = (OrganizerCreateChip) request.getAttribute(AbstractChip.CHIP_KEY);
      ...
      out.write("\r\n\t\t\t<td class=\"head\" align=\"left\"><span style=\"white-space:nowrap\">");
      out.print(localized("type"));
      out.write(":</span></td>\r\n\t\t\t<td align=\"left\" colspan=\"2\">\r\n\t\t\t\t<select name=\"");
      out.print(theChip.getEventID(OrganizerCreateChip.TYPECODE));
      out.write("\" onchange=\"setScrollAndSubmit();\">\r\n");
      ...
      out.write("\r\n\t\t\t\t\t\t\t");
      out.print( entry.isAbstract() ? " class=\"disabled\"" : "" );
      out.write(" \r\n\t\t\t\t\t\t>\r\n\t\t\t\t\t\t\t");
      out.print( entry.getDisplayName() );
      out.write("\r\n\t\t\t\t\t\t</option>\r\n");
      ...
      out.write("\r\n\t\t\t");
      out.print( xpButton( localized("create"), theChip.getCommandID(OrganizerCreateChip.CREATE), localized("create") ) );
      out.write('\r');
      out.write('\n');
