...
public final class mediaFileUploadEditorChip_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/media/../head.inc", Long.valueOf(1427445216000L));
  }
...
//	boolean editable = theChip.isURLEditable();
	...
	if( showPreview )
	{
      ...
      out.print(localized("preview"));
      out.write(":</td>\r\n\t\t\t<td class=\"noLocalizationFlag\">&nbsp;</td>\r\n\t\t\t<td class=\"preview\">\r\n\t\t\t\t<img src=\"");
      out.print( theChip.getURL() );
      out.write("\"/>\r\n\t\t\t</td>\r\n\t\t</tr>\r\n");

	}

      out.write("\r\n\t<tr>\r\n\t\t<td class=\"arrowButton\">&nbsp;</td>\r\n\t\t<td class=\"attrLabel\">");
      out.print(localized("url"));
      ...
      out.print( (theChip.getURL()==null ? "" : theChip.getURL()) );
 ...
 theChip.getNoAccessChip().render( pageContext ); 
      ...
      out.print( isUploadEnabled ? " chip-event" : "-disabled" );
      out.write("\">\r\n\t\t\t\t\t\t\t \t<a href=\"#\" title=\"");
      out.print( localized("upload") );
      out.write("\"   \r\n\t\t\t\t\t\t\t\t");
      out.print( isUploadEnabled ? "name=\"" + theChip.getCommandID(MediaFileUploadEditorChip.UPLOAD) + "\"" : "" );
      out.write(" \r\n\t\t\t\t\t\t\t\tid=\"");
      out.print( theChip.getUniqueName() );
      out.write("_upload_a\"\r\n\t\t\t\t\t\t\t\thidefocus=\"true\">\r\n\t\t\t\t\t\t\t\t<span id=\"");
      out.print( theChip.getUniqueName() );
      out.write("_upload_span\">\r\n\t\t\t\t\t\t\t\t\t<img class=\"icon\" src=\"images/icons/button_upload");
      out.print( isUploadEnabled ? "" : "_disabled" );
      out.write(".gif\" id=\"");
      out.print( theChip.getUniqueName() );
      out.write("_upload_img\"/>\r\n\t\t\t\t\t\t\t\t\t<div class=\"label\" id=\"");
      out.print( theChip.getUniqueName() );
      out.write("_upload_div\">\r\n\t\t\t\t\t\t\t\t\t\t");
      out.print( localized("upload") );
      out.write("\r\n\t\t\t\t\t\t\t\t\t</div>\r\n\t\t\t\t\t\t\t\t</span>\r\n\t\t\t\t\t\t\t</a>\r\n\t\t\t\t\t\t</div>\r\n\t\t\t\t\t</td>\r\n\t\t\t\t\t<td>\r\n\t\t\t\t\t\t<div class=\"xp-button");
      out.print( isPreviewEnabled ? " open-url" : "-disabled" );
      out.write("\">\r\n\t\t\t\t\t\t\t<a href=\"#\" title=\"");
      out.print( localized("preview") );
      out.write("\" \r\n\t\t\t\t\t\t\t\t");
      out.print( isPreviewEnabled ? "name=\"" + theChip.getURL() + "\"" : "" );
      out.write(" \r\n\t\t\t\t\t\t\t\tid=\"");
      out.print( theChip.getUniqueName() );
      out.write("_preview_a\"\r\n\t\t\t\t\t\t\t>\r\n\t\t\t\t\t\t\t\t<span id=\"");
      out.print( theChip.getUniqueName() );
      out.write("_preview_span\">\r\n\t\t\t\t\t\t\t\t\t<img class=\"icon\" src=\"images/icons/button_preview");
      out.print( isPreviewEnabled ? "" : "_disabled" );
      out.write(".gif\" id=\"");
      out.print( theChip.getUniqueName() );
      out.write("_preview_img\"/>\r\n\t\t\t\t\t\t\t\t\t<div class=\"label\" id=\"");
      out.print( theChip.getUniqueName() );
      out.write("_preview_div\">\r\n\t\t\t\t\t\t\t\t\t\t");
      out.print( localized("preview") );
      out.write("\r\n\t\t\t\t\t\t\t\t\t</div>\r\n\t\t\t\t\t\t\t\t</span>\r\n\t\t\t\t\t\t\t</a>\r\n\t\t\t\t\t\t</div>\r\n\t\t\t\t\t</td>\r\n\t\t\t\t\t<td>\r\n\t\t\t\t\t\t<div class=\"xp-button");
      out.print( isDownloadEnabled ? " open-url" : "-disabled" );
      out.write("\">\r\n\t\t\t\t\t\t\t<a href=\"#\" title=\"");
      out.print( localized("download") );
      out.write("\" \r\n\t\t\t\t\t\t\t");
      out.print( isDownloadEnabled ? "name=\"" + theChip.getDownloadURL() + "\"" : "" );
      out.write(" \r\n\t\t\t\t\t\t\t\tid=\"");
      out.print( theChip.getUniqueName() );
      out.write("_download_a\"\r\n\t\t\t\t\t\t\t>\r\n\t\t\t\t\t\t\t\t<span id=\"");
      out.print( theChip.getUniqueName() );
      out.write("_download_span\">\r\n\t\t\t\t\t\t\t\t\t<img class=\"icon\" src=\"images/icons/button_download");
      out.print( isDownloadEnabled ? "" : "_disabled" );
      out.write(".gif\" id=\"");
      out.print( theChip.getUniqueName() );
      out.write("_download_img\"/>\r\n\t\t\t\t\t\t\t\t\t<div class=\"label\" id=\"");
      out.print( theChip.getUniqueName() );
      out.write("_download_div\">\r\n\t\t\t\t\t\t\t\t\t\t");
      out.print( localized("download") );
      out.write("\r\n\t\t\t\t\t\t\t\t\t</div>\r\n\t\t\t\t\t\t\t\t</span>\r\n\t\t\t\t\t\t\t</a>\r\n\t\t\t\t\t\t</div>\r\n\t\t\t\t\t</td>\r\n\t\t\t\t</tr>\r\n\t\t\t</table>\r\n\t\t</td>\r\n\t</tr>\r\n\t<tr>\r\n\t\t<td class=\"arrowButton\">&nbsp;</td>\r\n\t\t<td class=\"attrLabel\">");
      out.print(localized("mime"));
      out.write(":</td>\r\n\t\t<td class=\"noLocalizationFlag\">&nbsp;</td>\r\n\t\t<td class=\"preview\">\r\n\t\t");
      ...
      out.write("\r\n\t\t\t\t<input\r\n\t\t\t\t\tclass=\"");
      out.print((theChip.isMimeEditable()?"enabled":"disabled"));
      out.write("\" type=\"text\" \r\n\t\t\t\t\tname=\"");
      out.print(theChip.getEventID(MediaFileUploadEditorChip.SET_MIME));
      out.write("\" \r\n\t\t\t\t\tvalue=\"");
      out.print((theChip.getMime() != null ? theChip.getMime() : ""));
      out.write("\" \r\n\t\t\t\t\tid=\"");
      out.print( theChip.getUniqueName() );
      out.write("_mime\"\r\n\t\t\t\t\t");
      out.print((theChip.isMimeEditable()?"":"readonly"));
      out.write(">\r\n\t\t\t\t");
 ...
 theChip.getNoAccessChip().render( pageContext ); 
      ...
      out.write("\r\n\t\t</td>\r\n\t</tr>\r\n\t<tr>\r\n\t\t<td class=\"arrowButton\">&nbsp;</td>\r\n\t\t<td class=\"attrLabel\">");
      out.print(localized("realfilename"));
      out.write(":</td>\r\n\t\t<td class=\"noLocalizationFlag\" >&nbsp;</td>\r\n\t\t<td>\r\n\t\t");
      ...
      out.print((theChip.isMimeEditable()?"enabled":"disabled"));
      out.write("\" type=\"text\" \r\n\t\t\t\t\tname=\"");
      out.print(theChip.getEventID(MediaFileUploadEditorChip.SET_REAL_FILENAME));
      out.write("\" \r\n\t\t\t\t\tvalue=\"");
      out.print((theChip.getRealFileName() != null ? theChip.getRealFileName() : ""));
      out.write("\"\r\n\t\t\t\t\tid=\"");
      out.print( theChip.getUniqueName() );
      out.write("_realfilename\"\r\n\t\t\t\t\t");
      out.print((theChip.isRealFileNameEditable()?"":"readonly"));
      out.write(">\r\n\t\t\t\t");
