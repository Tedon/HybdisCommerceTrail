...
import de.hybris.platform.voucher.hmc.VoucherCodeGeneratorChip;
import de.hybris.platform.voucher.jalo.Voucher;

public final class VoucherCodeGeneratorChip_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	*/
	...
	boolean active = theChip.isActive();
      ...
      out.print( localized("text.serialvoucher.setquantity.label" ));
      out.write("\n\t\t\t</td>\n\t\t\t<td>\n\t\t\t\t<input class=\"editorform\" size=\"6\" type=\"text\" \n\t\t\t\t\t\t id=\"");
      out.print( theChip.getUniqueName() );
      out.write("_input\"\n\t\t\t\t\t\t name=\"");
      out.print( theChip.getEventID(VoucherCodeGeneratorChip.QUANTITY) );
      out.write("\" value=\"1\" ");
      out.print( (active ? "" : "disabled") );
      out.write("&nbsp;\n\t\t\t</td>\n\t\t\t<td>&nbsp;</td>\n\t\t\t<td>\n\t\t\t\t<div class=\"xp-button");
      out.print( active ? " chip-event" : "-disabled" );
      out.write("\">\n\t\t\t\t\t<a style=\"width:100px;\" href=\"#\" title=\"");
      out.print( localized("btn.generate.voucher.codes") );
      out.write("\" name=\"");
      out.print( theChip.getEventID(VoucherCodeGeneratorChip.GENERATE) );
