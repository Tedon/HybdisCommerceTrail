...
public final class textAreaLayoutChip_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if( theChip.isMultiLine() || theChip.isExpanded() ){
      ...
      out.write("_textarea_hidden\").value=B64.encode(element.value);\r\n        ");
}else{
      out.write("\r\n        document.getElementById(\"");
      out.print( theChip.getUniqueName() );
      out.write("_input_hidden\").value=B64.encode(element.value);\r\n        ");
}
      out.write("\r\n\t}\r\n\t");
	...
	if( theChip.isBase64()){
      ...
      out.write("\r\n\t\t\t\t<textarea\r\n\t\t\t\t\t\tid=\"");
      out.print( theChip.getUniqueName() );
      out.write("_textarea_hidden\"\r\n\t\t\t\t\t\tname=\"");
      out.print( theChip.getEventID(TextAreaLayoutChip.SET_BASE64) );
      ...
      out.write("\"\r\n\t\t\t\t\t");
      out.print( theChip.getCols() == null ? "style=\"width:" + width + "px;\"" : "" );
      out.write("\r\n\t\t\t\t\tname=\"");
      out.print( theChip.getEventID(TextAreaLayoutChip.SET_VALUE) );
      out.write("\"\r\n\t\t\t\t\t");
      out.print( theChip.getCols() != null ? "cols=\"" + theChip.getCols() + "\"" : "" );
      out.write("\r\n\t\t\t\t\trows=\"");
      out.print( (theChip.getRows()!=null?theChip.getRows().toString():"9") );
      out.write("\"\r\n\t\t\t\t\twrap=\"");
      out.print( (theChip.isWrapping()?"virtual":"off") );
      ...
      out.print( theChip.getUniqueName() );
      out.write("_textarea\"\r\n\t\t\t\t\t");
      out.print( theChip.isEditable() ? "" : "readonly=\"readonly\"" );
      out.write('>');
      out.print( theChip.getQuotedStringValue() );
      out.write("</textarea>\r\n");
      ...
      out.print( width );
      out.write("px;\"\r\n\t\t\t\t\t");
      out.print( maxLength != 0 ? "maxlength=\"" + maxLength + "\"" : "" );
      out.write("\r\n\t\t\t\t\t");
      out.print( onKeyPressString );
      out.write("\r\n\t\t\t\t");
 ...
 if( theChip.isMultiLine() || theChip.isExpanded() ){
      out.write("\r\n\tencode(document.getElementById(\"");
      out.print( theChip.getUniqueName() );
      out.write("_textarea\"));\r\n");
}else{
      out.write("\r\n\tencode(document.getElementById(\"");
