...
public final class listSearchAndReplaceChip_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/generic/organizer/../../head.inc", Long.valueOf(1427445216000L));
  }
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	*/
	...
	boolean noColumns = theChip.getSearchableColumns().isEmpty();
      ...
      out.print( localized("list.searchreplace.no.columns") );
      out.write("\r\n\t\t\t\t</span>\r\n");
      ...
      out.write("\t\t\t\r\n\t\t\t\t<select name=\"");
      out.print( theChip.getEventID(ListSearchAndReplaceChip.CURRENT_COLUMN ));
      out.write("\" onchange=\"editorForm.submit()\" id=\"");
      ...
      out.write("\r\n\t\t\t\t\t\t\t\t<option");
      out.print( (column.equals(theChip.getCurrentColumn()) ? " selected" : "") );
      out.write(" value=\"");
      out.print( column );
      out.write('"');
      out.write('>');
      out.print( theChip.getAttributeDescriptorName(column) );
      out.write("</option>\r\n");
      ...
      out.write("\r\n\t\t\t<td>");
      out.print( localized("notdefined") );
      out.write("</td>\r\n");
      ...
      out.write("\r\n\t\t\t<td>");
theChip.getOldValueEditor().render(pageContext);
      out.write("</td>\r\n");

		}

      out.write("\r\n\t</tr>\r\n\t<tr>\r\n\t\t<td>");
      out.print(localized("newvalue"));
      out.write(":</td>\r\n");
      ...
      out.write("\r\n\t\t\t<td>");
theChip.getNewValueEditor().render(pageContext);
      out.write("</td>\r\n");
      ...
      out.print( theChip.getEventID(ListSearchAndReplaceChip.SUBSTRING) );
      out.write("\" value=\"false\">\r\n\t\t\t\t\t<td>");
      out.print( localized("substring") );
      out.write(":</td>\r\n\t\t\t\t\t<td>\r\n\t\t\t\t\t\t<input type=\"checkbox\" \r\n\t\t\t\t\t\t\t\t name=\"");
      out.print( theChip.getEventID(ListSearchAndReplaceChip.SUBSTRING) );
      out.write('"');
      out.print((theChip.isUsingSubstrings()?" checked":""));
      out.write(" \r\n\t\t\t\t\t\t\t\t value=\"true\" \r\n\t\t\t\t\t\t\t\t ");
      out.print( noColumns ? "disabled" : "" );
      out.write(" \r\n\t\t\t\t\t\t\t\t id=\"");
      out.print( theChip.getUniqueName() );
      out.write("_substring\"></td>\r\n\t\t\t\t</tr>\r\n\t\t\t");

		}
	
      out.write("\r\n\t<tr>\r\n\t\t<td>");
      out.print(localized("mode"));
      out.write(":</td>\r\n\t\t<td>\r\n\t\t\t<input type=\"radio\" \r\n\t\t\t\t\tname=\"");
      out.print(theChip.getEventID(ListOperationChip.SELECTED_ONLY));
      out.write("\" \r\n\t\t\t\t\tvalue=\"");
      out.print(AbstractChip.FALSE);
      out.write('"');
      out.print((theChip.doesOnlySelected()?"":" checked"));
      out.write(" \r\n\t\t\t\t\tid=\"");
      out.print( theChip.getUniqueName() );
      out.write("_allvisible\"\r\n\t\t\t\t\t");
      out.print( noColumns ? "disabled" : "" );
      out.write('>');
      out.print(localized("allvisible"));
      out.write("\r\n\t\t\t&nbsp;&nbsp;\r\n\t\t\t<input type=\"radio\" \r\n\t\t\t\t\tname=\"");
      out.print(theChip.getEventID(ListOperationChip.SELECTED_ONLY));
      out.write("\" \r\n\t\t\t\t\tvalue=\"");
      ...
      out.write(" \r\n\t\t\t\t\tid=\"");
      out.print( theChip.getUniqueName() );
      out.write("_selectedonly\"\r\n\t\t\t\t\t");
      out.print( noColumns ? "disabled" : "" );
      out.write('>');
      out.print(localized("selectedonly"));
      out.write("\r\n\t\t</td>\r\n\t</tr>\r\n\t<tr>\r\n\t\t<td>\r\n\t\t\t<div class=\"xp-button");
      out.print( !noColumns ? " chip-event" : "-disabled" );
      out.write("\">\r\n\t\t\t\t<a style=\"width:130px;\" href=\"#\" title=\"");
      out.print( localized("list.searchreplace.perform") );
      out.write("\" name=\"");
      out.print( theChip.getCommandID(ListSearchAndReplaceChip.PERFORM) );
