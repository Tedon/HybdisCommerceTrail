...
public final class draggableItemListChip_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	*/
	...
	final boolean showScrollbars = ConfigConstants.getInstance().ENABLE_SCROLLBAR;
      ...
      out.write("\r\n\t\t<table id=\"resultTable_");
      out.print( theChip.getID() );
      out.write("\" class=\"genericItemListChip\" cellspacing=\"0\" cellpadding=\"0\" oncontextmenu=\"");
      ...
      out.write("\r\n\t\t\t\t\t\t<table id=\"table_");
      out.print( theChip.getID() );
      out.write("_table\" class=\"listtable selecttable");
	...
	for( final Iterator iter = theChip.getChildNodes().iterator(); iter.hasNext(); )
	{
      ...
      out.write("\r\n\t\t\t\t\t\t\t\t<!-- gilcHeaderAttribte -->\r\n\t\t\t\t\t\t\t\t<th>\r\n\t\t\t\t\t\t\t\t\t<div class=\"gilcEntry");
      out.print( theChip.isMarkedAsMandatory(qualifier) ? "-mandatory" : "" );
      out.write("\" style=\"");
      out.print( editable ? "" : "color:#999999;");
      out.print( attributeWidth > 0 ? "width:" + attributeWidth + "px;" : "" );
      out.write("\" title=\"");
      out.print( theChip.getTitle(qualifier) );
      out.write('"');
      out.write('>');
      out.print( theChip.getTitle(qualifier) );
      out.write("</div>\r\n\t\t\t\t\t\t\t\t</th>\r\n");
	...
	else
	{
      ...
      out.write("\r\n\t\t\t\t\t\t\t\t<tr id=\"");
      out.print( chip.getItem().getPK() );
      out.write("\" class=\"draggable ");
      out.print( prohibitOpening ? "" : "doubleclick-event " + chip.getCommandID(GenericItemListEntryChip.OPEN_EDITOR) );
      out.write("\" onclick=\"\">\t");
      out.write("\r\n\t\t\t\t\t\t\t\t\t<!-- gilcCheckbox -->\r\n\t\t\t\t\t\t\t\t\t<td class=\"checkbox gilcCheckbox\" id=\"");
      out.print( theChip.getUniqueName() );
      out.write("_td\">\r\n\t\t\t\t\t\t\t\t\t\t<input type=\"");
      out.print( ( theChip.isMultipleSelectionAllowed() ? "checkbox" : "radio" ) );
      out.write("\" \r\n\t\t\t\t\t\t\t\t\t\t\t\t name=\"");
	...
	if(theChip.getSearchEditor()!=null)
	{
      ...
      out.write("\r\n</tbody>\r\n\t\t\t\t\t\t</table>\r\n\t\t\t\t\t<script language=\"JavaScript1.2\">\r\n\t\t\t\t\t\tSortable.create(\"");
      out.print( theChip.getUniqueName() );
      out.write("_tbody\",{onUpdate:y_dragListItem,tag:'tr',only:'draggable',ghosting:false,format:/(.*)/});\r\n\t\t\t\t\t</script>\r\n\t\t\t\t\t</div>\r\n\t\t\t\t</td>\r\n\t\t\t</tr>\r\n");
