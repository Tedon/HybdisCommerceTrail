...
public final class actionDialogContainerChip_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	*/
	...
	final ActionDialogContainerChip theChip = (ActionDialogContainerChip) request.getAttribute(AbstractChip.CHIP_KEY);
      ...
      out.print( localized("searchresultaction") );
      out.write(':');
      out.write(' ');
      out.print( localized(theChip.getActionChip().getName()) );
      out.write("\r\n\t\t\t\t</div>\r\n\t\t\t</td>\r\n\t\t</tr>\r\n\t\t<tr>\r\n\t\t\t<td class=\"dialogChip\">\r\n");

				theChip.getDialogChip().render(pageContext);

      out.write("\r\n\t\t\t</td>\r\n\t\t</tr>\r\n\t\t<tr>\r\n\t\t\t<td class=\"buttons\">\r\n\t\t\t\t<table border=\"0\" cellspacing=\"0\" cellpadding=\"0\">\r\n\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t<td>\r\n\t\t\t\t\t\t\t<div class=\"xp-button chip-event\">\r\n\t\t\t\t\t\t\t\t<a href=\"#\" style=\"width:120px\" title=\"");
      out.print( localized("performaction") );
      out.write("\" name=\"");
      out.print( theChip.getCommandID(ActionDialogContainerChip.PERFORM) );
      out.write("\" hidefocus=\"true\">\r\n\t\t\t\t\t\t\t\t\t<span class=\"label\">\r\n\t\t\t\t\t\t\t\t\t\t");
      out.print( localized("performaction") );
      out.write("\r\n\t\t\t\t\t\t\t\t\t</span>\r\n\t\t\t\t\t\t\t\t</a>\r\n\t\t\t\t\t\t\t</div>\t\t\r\n\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t<td style=\"padding-left:5px;\">\r\n\t\t\t\t\t\t\t<div class=\"xp-button chip-event\">\r\n\t\t\t\t\t\t\t\t<a href=\"#\" style=\"width:120px\" title=\"");
      out.print( localized("cancel") );
      out.write("\" name=\"");
      out.print( theChip.getCommandID(ActionDialogContainerChip.CANCEL) );
      out.write("\" hidefocus=\"true\">\r\n\t\t\t\t\t\t\t\t\t<span class=\"label\">\r\n\t\t\t\t\t\t\t\t\t\t");
      out.print( localized("cancel") );
