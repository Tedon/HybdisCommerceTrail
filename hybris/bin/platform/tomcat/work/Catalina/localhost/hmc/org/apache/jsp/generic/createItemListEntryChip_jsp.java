...
public final class createItemListEntryChip_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	*/
	...
	for( final Iterator it = theChip.getChildNodes().iterator(); it.hasNext(); )
	{
      ...
      out.write("\r\n\t\t\t\t\t\t<td class=\"lastEntry\">\r\n\t\t\t\t\t\t\t<div>\r\n\t\t\t\t\t\t\t\t");
      out.print( getIconButton(theChip.getParent().getCommandID(GenericItemListChip.DELETE_NEW_ENTRY), 
