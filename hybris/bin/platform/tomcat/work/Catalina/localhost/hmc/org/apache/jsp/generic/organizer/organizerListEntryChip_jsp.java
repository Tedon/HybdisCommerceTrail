...
public final class organizerListEntryChip_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	*/
	...
	if( !theChip.isElementReadable() )
	{
      ...
      out.write("\r\n\t\t\t<td colspan=\"");
      out.print( theChip.getAttributeCount()+2 );
      out.write('"');
      out.write('>');
	...
	else
	{
      ...
      out.write("\r\n\t\t<!-- isChangedSign -->\r\n\t\t<td class=\"olecIsChangedSign\" ");
      out.print( (theChip.isChanged() ? itemChangedTooltip : "") );
      out.write(" id=\"");
      ...
      out.write("\r\n\t\t\t</div>\r\n\t\t</td>\r\n\t\t\r\n\t\t<!-- icon -->\r\n\t\t<td class=\"olecIcon\" id=\"");
      out.print( theChip.getUniqueName() );
      out.write("_td2\">\r\n\t\t\t<div class=\"olecIcon\" >\r\n\t\t\t\t<div class=\"button-on-white chip-event\">\r\n\t\t\t\t\t<a href=\"#\" title=\"");
      out.print( localized("open_editor") );
      out.write("\" hidefocus=\"true\"\r\n\t\t\t\t\t\tname=\"");
      out.print( theChip.getCommandID(GenericItemListEntryChip.OPEN_EDITOR) );
      out.write("\">\r\n\t\t\t\t\t\t<span id=\"");
      out.print( theChip.getUniqueName() );
      out.write("_span\">\r\n\t\t\t\t\t\t\t<img class=\"icon\" src=\"");
      ...
      out.print( width );
      out.write(" id=\"");
      out.print( displayChip != null ? displayChip.getUniqueName() : theChip.getUniqueName() + "_item" );
      out.write("_td3\">\r\n\t\t\t\t\t<div class=\"olecEntry\" ");
      out.print( width );
      out.write(" id=\"");
      out.print( displayChip != null ? displayChip.getUniqueName() : theChip.getUniqueName() + "_item" );
      ...
      out.write("\r\n\t\t\t\t\t\t<a href=\"");
      out.print( displayChip.getLinkUrl() );
      out.write("\"\r\n\t\t\t\t\t\tonMouseover=\"window.status='");
      out.print( localized( displayChip.getLinkTitle() ) );
      ...
      out.print( target );
      out.write("\r\n\t\t\t\t\t\tid=\"");
      out.print( displayChip.getUniqueName() );
      out.write("_a\">\r\n");
      ...
      out.write(" style=\"");
      out.print( width );
      out.write("\">\r\n\t\t\t\t\t<div class=\"olecEntry\" style=\"");
      out.print( width );
      out.write(";\">\r\n\t\t\t\t\t\t");
      out.print( theChip.getItemAsString() );
      out.write("\r\n\t\t\t\t\t</div>\r\n\t\t\t\t</td>\r\n");
