...
import de.hybris.platform.catalog.hmc.*;

public final class booleanClassificationAttributeEditorChip_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	*/
	...
	final BooleanClassificationAttributeEditorChip theChip = (BooleanClassificationAttributeEditorChip) request.getAttribute(AbstractChip.CHIP_KEY);

	final boolean isRange = theChip.isRange();		// doesn't make much sense for booleans, but it is possible
	...
	final String contextMenu = theChip.hasVisibleContextMenuEntries()
      ...
      out.write("\r\n\t\t\t\t<td title=\"");
      out.print( theChip.getTooltip(i) );
      out.write("\">\r\n");
      ...
      out.print( localized("classification.editor.edit.description") );
      ...
      out.print( localized(i == 0 ? "classification.editor.add" : "classification.editor.remove" ) );
      out.write("\" \r\n\t\t\t\t\t\t\t\tname=\"");
      out.print( theChip.getCommandID(i == 0 ? AbstractClassificationAttributeEditorChip.ADD : AbstractClassificationAttributeEditorChip.REMOVE) );
      out.write("\">\r\n\t\t\t\t\t\t\t\t<span class=\"event-value\">");
      out.print( i == 0 ? "true" : i );
      out.write("</span>\r\n\t\t\t\t\t\t\t\t<span style=\"padding-left:3px;\">\r\n\t\t\t\t\t\t\t\t\t<img class=\"icon\" src=\"images/icons/list_menu_");
      out.print( i == 0 ? "add" : "remove" );
      out.write(".gif\">\r\n\t\t\t\t\t\t\t\t</span>\r\n\t\t\t\t\t\t\t</a>\r\n\t\t\t\t\t\t</div>\r\n\t\t\t\t\t</td>\r\n");
      ...
      out.print( localized("classification.editor.range.to") );
      out.write("\r\n\t\t\t\t\t</td>\r\n");
