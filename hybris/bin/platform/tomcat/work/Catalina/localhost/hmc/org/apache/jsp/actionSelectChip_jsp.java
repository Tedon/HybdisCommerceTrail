...
public final class actionSelectChip_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/xp_button.inc", Long.valueOf(1427445216000L));
  }
 ...
 if( DEBUG_COMMENTS ) { 
	...
	final String tooltip = theChip.getTooltip() != null ? localized(theChip.getTooltip()) : "";
      ...
      out.write("\r\n\r\n<script language=\"JavaScript\" type=\"text/JavaScript\">\r\n\t\r\n\tvar actionConfirmationFlags_");
      out.print( actionEventId );
      out.write(" = new Array( ");
      out.print( actions.size() );
      out.write(" );\r\n\tvar actionConfirmationMessages_");
      out.print( actionEventId );
      out.write(" = new Array( ");
      out.print( actions.size() );
      out.write(" );\r\n\t");
      ...
      out.write("actionConfirmationFlags_");
      out.print( actionEventId );
      out.write('[');
      out.print( i );
      out.write("] = ");
      out.print( needConfirmation ? 1 : 0 );
      out.write(";\r\n\tactionConfirmationMessages_");
      out.print( actionEventId );
      out.write('[');
      out.print( i );
      out.write("] = '");
      ...
      out.write("\r\n\tvar noActionSelectedMessage_");
      out.print( actionEventId );
      out.write(" = '");
      out.print( escapeHTML(theDisplayState.getLocalizedString( "noactionselected" )) );
      out.write("';\r\n\r\n\tfunction getConfirmIfNeeded_");
      out.print( actionEventId );
      out.write("( formElement, event )\r\n\t{\r\n\t\tvar val = formElement.elements[event].value;\r\n\t\tif( val >= 0 && val < actionConfirmationFlags_");
      out.print( actionEventId );
      out.write(".length )\r\n\t\t{\r\n\t\t\tvar flag = actionConfirmationFlags_");
      out.print( actionEventId );
      out.write("[ val ];\r\n\t\t\tif( flag == 1 )\r\n\t\t\t{\r\n\t\t\t\treturn confirm( actionConfirmationMessages_");
      out.print( actionEventId );
      out.write("[ val ] );\r\n\t\t\t}\r\n\t\t}\r\n\t\telse\r\n\t\t{\r\n\t\t\talert( noActionSelectedMessage_");
      out.print( actionEventId );
      out.write(" );\r\n\t\t\treturn false;\r\n\t\t}\r\n\t\t\r\n\t\treturn true;\r\n\t}\r\n\r\n</script>\r\n");
	...
	if( !actions.isEmpty() )
	{
      ...
      out.print( tooltip );
      out.write("\">\r\n\t\t\t\t<tr>\r\n\t\t\t\t\t<td style=\"color:#000000; padding:0 4px 0 3px;\">");
      out.print( localized("toolbaractions") );
      out.write(":</td>\r\n\t\t\t\t\t<td>\r\n\t\t\t\t\t\t<script language=\"JavaScript1.2\" type=\"text/javascript\">\r\n\t\t\t\t\t\t  markClipStart(2);\r\n\t\t\t\t\t\t</script>\r\n\t\t\t\t\t\t\r\n\t\t\t\t\t\t<select \r\n\t\t\t\t\t\t\tonkeypress=\"return true;\"\r\n\t\t\t\t\t\t\tonchange=\"return true;\"\r\n\t\t\t\t\t\t\tname=\"");
      out.print( actionEventId );
      out.write("\">\r\n\t\t\t\t\t\t\t<option value=\"-1\">");
      out.print( localized( "noselection" ) );
      out.write("</option>\r\n\t\t\t\t\t\t");
      ...
      out.print(i);
      out.write('"');
      out.print((selected ? " selected=\"selected\"" : ""));
      out.write('>');
      out.print( localized( action.getName() ) );
      out.write("</option>\r\n\t\t\t\t\t\t\t\t");
      ...
      out.print( xpButtonWithCondition( buttonContent, theChip.getCommandID( ActionSelectChip.PERFORM_ACTION ), "", false, "getConfirmIfNeeded_" + actionEventId + "( currentForm, '" + actionEventId + "' )" ) );
