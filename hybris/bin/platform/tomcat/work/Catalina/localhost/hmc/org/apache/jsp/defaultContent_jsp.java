...
public final class defaultContent_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/head.inc", Long.valueOf(1427445216000L));
  }
   ...
   */	
    ...
    */
      ...
      out.print(localized("licence.version"));
      out.write(":</td> \r\n\t\t\t\t\t<td class=\"padding\">");
      out.print(Config.getParameter("build.description"));
      out.write("</td>\r\n\t\t\t\t</tr>\r\n\t\t\t\t<tr>\r\n\t\t\t\t\t<td>&nbsp;</td><td>");
      out.print(Config.getParameter("build.version"));
      out.write("</td>\r\n\t\t\t\t</tr>\r\n\t\t\t\t<tr>\r\n\t\t\t\t\t<td>&nbsp;</td><td>");
      out.print(localized("licence.lastcompile"));
      out.write(':');
      out.write(' ');
      out.print(Config.getParameter("build.builddate"));
      out.write("</td>\r\n\t\t\t\t</tr>\r\n\t\t\t\t<tr>\r\n\t\t\t\t\t<td>&nbsp;</td><td>");
      out.print(localized("licence.releasedate"));
      out.write(':');
      out.write(' ');
      out.print(Config.getParameter("build.releasedate"));
      out.write("</td>\r\n\t\t\t\t</tr>\r\n\r\n\t\t\t\t<tr>\r\n\t\t\t\t\t<td class=\"padding\">");
      out.print(localized("licence.server"));
      out.write(":</td> \r\n\t\t\t\t\t<td class=\"padding\">");
      out.print(request.getServerName()+":"+request.getServerPort());
      out.write("</td>\r\n\t\t\t\t</tr>\r\n\t\t\t\t<tr>\r\n\t\t\t\t\t<td>");
      out.print(localized("licence.locale"));
      out.write(":</td> \r\n\t\t\t\t\t<td>");
      out.print(JaloSession.hasCurrentSession()?JaloSession.getCurrentSession().getSessionContext().getLocale().getDisplayName(JaloSession.getCurrentSession().getSessionContext().getLocale())+" - "+JaloSession.getCurrentSession().getSessionContext().getLocale():"n/a");
      out.write("</td>\r\n\t\t\t\t</tr>\r\n\t\t\t\t<tr>\r\n\t\t\t\t\t<td>");
      out.print(localized("licence.timezone"));
      out.write(":</td> \r\n\t\t\t\t\t<td>");
      out.print(JaloSession.hasCurrentSession()?JaloSession.getCurrentSession().getSessionContext().getTimeZone().getDisplayName(JaloSession.getCurrentSession().getSessionContext().getLocale())+" - "+JaloSession.getCurrentSession().getSessionContext().getTimeZone().getID():"n/a");
      out.write("</td>\r\n\t\t\t\t</tr>\r\n\t\t\t\t<tr>\r\n\t\t\t\t\t<td colspan=\"2\" class=\"headline\">");
      out.print(localized("licence.information"));
      out.write(":</td>\r\n\t\t\t\t</tr>\r\n\t\t\t\t<tr>\r\n\t\t\t\t\t<td>");
      out.print(localized("licence.id"));
      out.write(":</td><td>");
      out.print( licence.getID());
      out.write("</td>\r\n\t\t\t\t</tr>\r\n\t\t\t\t<tr>\r\n\t\t\t\t\t<td>");
      out.print(localized("licence.name"));
      out.write(":</td><td>");
      out.print( licence.getName());
      out.write("</td>\r\n\t\t\t\t</tr>\r\n\t\t\t\t");
      ...
      out.write("\r\n\t\t\t\t<tr>\r\n\t\t\t\t\t<td>");
      out.print(localized("licence.expirationdate"));
      out.write(":</td><td>");
      out.print(expdateS);
      out.write("</td>\r\n\t\t\t\t</tr>\r\n\t\t\t</table>\r\n");
