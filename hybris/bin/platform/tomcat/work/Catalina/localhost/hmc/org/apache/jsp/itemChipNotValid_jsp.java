...
public final class itemChipNotValid_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if( DEBUG_COMMENTS ) { 
	...
	ItemChip theChip = (ItemChip) request.getAttribute(AbstractChip.CHIP_KEY);
      ...
      out.print(localized("itemchipnotvalid"));
      out.write("\r\n\t\t\t</td>\r\n\r\n\t\t</tr>\r\n\t\t<tr>\r\n\t\t\t<td style=\"icnvOkButton\">\r\n\t\t\t\t\t");
      out.print( xpButtonWithCondition("<span style=\"width:60px; text-align:center;\">" + localized("ok") + "</span>",
