...
import de.hybris.platform.lucenesearch.hmc.SearchTab;
import de.hybris.platform.lucenesearch.hmc.SearchResultChip;
import de.hybris.platform.lucenesearch.hmc.SearchGroupChip;

public final class SearchTab_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/ext/lucenesearch/../../head.inc", Long.valueOf(1427445216000L));
    _jspx_dependants.put("/ext/lucenesearch/../../xp_button.inc", Long.valueOf(1427445216000L));
  }
 ...
 if( DEBUG_COMMENTS ) { 
	...
	SearchTab theChip = (SearchTab) request.getAttribute(AbstractChip.CHIP_KEY);
      ...
      out.print( localized("lucenesearch.search.title") );
      out.write("\r\n\t\t</td>\r\n\t</tr>\r\n\t<tr>\r\n\t\t<td><img width=\"6\" height=\"1\" src=\"images/transparent.gif\" /></td>\r\n\t\t<td>\r\n\t\t\t<table style=\"width:100%\">\r\n\t\t\t\t\r\n\t\t\t\t<tr>\r\n\t\t\t\t\t<td colspan=\"2\" style=\"padding-top:5px; padding-left:5px;\">\r\n\t\t\t\t\t\t");
      out.print( localized("lucenesearch.search.explanation1") );
      out.write("<br>\r\n\t\t\t\t\t\t");
      out.print( localized("lucenesearch.search.explanation2") );
      out.write("\r\n\t\t\t\t\t</td>\r\n\t\t\t\t</tr>\r\n\t\t\t\t<tr>\r\n\t\t\t\t\t<td style=\"padding-left:5px;\">\r\n\t\t\t\t\t\t");
      out.print(localized("lucenesearch.search.pattern"));
      out.write(":\r\n\t\t\t\t\t</td>\r\n\t\t\t\t\t<td>\r\n\t\t\t\t\t\t<input\tclass=\"editorform\"  type=\"text\" size=\"50\" \r\n\t\t\t\t\t\t\t\t\tname=\"");
      out.print(theChip.getEventID(theChip.SEARCH_PATTERN));
      out.write("\" value=\"");
      out.print(theChip.getNextSearchPattern());
      ...
      out.write("</td>\r\n\t\t\t\t\t\t\t\t<script type=\"text/javascript\">\r\n\t\t\t\t\t\t\t\t\t\ttheLuceneSearchEventElement = document.editorForm.elements[\"");
      out.print(theChip.getCommandID(theChip.SEARCH_COMMAND));
      out.write("\"];\r\n\t\t\t\t\t\t\t\t</script>\r\n\t\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t</table>\r\n\t\t\t\t\t</td>\r\n\t\t\t\t</tr>\r\n\t\t\t\t");
      ...
      out.print(localized("lucenesearch.searchmessage.title"));
      out.write("</th></tr>\r\n\t\t\t\t\t\t<tr><td colspan=\"2\"><pre>");
      out.print(localized("lucenesearch.searchmessage.message"));
      out.write("</pre></td></tr>\r\n\t\t\t\t\t\t<tr><td colspan=\"2\"><pre>");
      out.print(theChip.getFailureMessage());
      out.write("</pre></td></tr>\r\n\t\t\t\t\t\t");
