...
public final class itemTreeViewChip_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	*/
	...
	final String tenantIDStr = Registry.getCurrentTenant() instanceof SlaveTenant ?
      ...
      out.write("_updater\" class=\"update-parent\">\r\n<table class=\"tree\" cellspacing=\"0\" cellpadding=\"0\">\r\n\t<tr>\r\n");

		if( theChip.isRoot() )
		{

      out.write("\r\n\t\t\t<td rowspan=\"2\" ");
      out.print( theChip.isLast() ? "" : "class=\"vertical\"" );
      out.write('>');
      out.write('\r');
      out.write('\n');
      ...
      out.write("\r\n\t\t\t\t\t<div class=\"");
      out.print( theChip.isLast() ? "end" : "horizontal" );
      out.write("\"></div>\r\n");
      ...
      out.write("\r\n\t\t<td ");
      out.print( !theChip.isRoot() ? "colspan=\"2\"" : "" );
      out.write(">\r\n\t\t\t<a href=\"#\" hidefocus=\"true\" onclick=\"setEvent('");
      out.print( theChip.getCommandID(ItemTreeViewChip.OPEN) );
      out.write("'); setScrollAndSubmit(); return false;\">\r\n\t\t\t\t<img border=\"0\" src=\"");
      out.print( theChip.getIcon() );
      out.write("\">&nbsp;");
      out.print( theChip.getLabel() );
      out.write("\r\n\t\t\t</a>\r\n\t\t</td>\r\n\t</tr>\r\n");
	...
	if( theChip.isExpanded() ) 
	{
      ...
      out.write("\r\n\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t<td ");
      out.print( it.hasNext() ? "class=\"vertical\"" : "" );
      out.write('>');
      out.write('\r');
      out.write('\n');
      ...
      out.write("\r\n\t\t\t\t\t\t\t\t\t<div class=\"");
      out.print( node.isLast() ? "end" : "horizontal" );
      out.write("\"></div>\r\n");

								}

      out.write("\r\n\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t<td style=\"vertical-align:middle; padding-left:3px;\">\r\n\t\t\t\t\t\t\t\t");
      out.print( node.getAttributeLabel());
      out.write("\r\n\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t<td class=\"");
      out.print( it.hasNext() ? "vertical" : "" );
      out.write("\" style=\"height:0px;\" >\r\n\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t<td  id=\"");
      out.print( node.getID() );
      out.write("_updater\" style=\"height:0px;\">\r\n\t\t\t\t\t\t\t\t");
