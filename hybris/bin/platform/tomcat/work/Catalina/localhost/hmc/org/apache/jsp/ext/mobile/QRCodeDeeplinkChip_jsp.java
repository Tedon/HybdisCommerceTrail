 ...
 */
package org.apache.jsp.ext.mobile;
...
import de.hybris.platform.mobileservices.hmc.QRCodeDeeplinkChip;
import java.util.*;

public final class QRCodeDeeplinkChip_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/ext/mobile/../../xp_button.inc", Long.valueOf(1427445216000L));
    _jspx_dependants.put("/ext/mobile/../../head.inc", Long.valueOf(1427445216000L));
  }
 ...
 if( DEBUG_COMMENTS ) { 
	...
	QRCodeDeeplinkChip chip = (QRCodeDeeplinkChip)request.getAttribute("theChip");
      ...
      out.print( chip.localized("header") );
    ...
    Map<String,String> campaigns =chip.getCampaigns();
     for (String k: campaigns.keySet()) {
      ...
      out.print( chip.localized("generate") );
      out.write("'  name='");
      out.print( chip.getCommandID(chip.GENERATE) );
      out.write("' hidefocus=\"true\">\r\n                            <p align=\"center\">\r\n                            <button>");
      out.print( chip.localized("generate") );
      out.write("</button>\r\n\t               \t\t\t</p>\r\n\t               \t\t\t</a>\r\n\t\t                    </div>\r\n\t\t \r\n                            <div id=\"regenerate-button\" style=\"display:none\" class=\"chip-event\">\r\n                            <a href=\"#\"   title='");
      out.print( chip.localized("regenerate") );
      out.write("'  name='");
      out.print( chip.getCommandID(chip.REGENERATE) );
      out.write("' hidefocus=\"true\">\r\n                            <p align=\"center\">\r\n                            <button>");
      out.print( chip.localized("regenerate") );
      out.write("</button>\r\n\t               \t\t\t</p>\r\n\t               \t\t\t</a>\r\n\t\t                    </div>\r\n\t\t                    \r\n\t\t                    \r\n                           \t\t\t\t\t\t\t\r\n\r\n<!-- Start Hybris footer -->\r\n\t\t\t\t\t\t</div>\r\n\t\t\t\t\t</td>\r\n\t\t\t\t</tr>\r\n\t\t\t</table>\r\n\t\t</td>\r\n\t</tr>\r\n</table>\r\n<!-- End hybris footer -->");
