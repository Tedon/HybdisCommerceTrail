...
public final class menuChip_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	*/
	...
	final MenuChip theChip = (MenuChip) request.getAttribute(AbstractChip.CHIP_KEY);
      ...
      out.write("\r\n<div style=\"width:");
      out.print( StructureLoader.getExplorerTreeWidth() );
      ...
      out.print( theChip.isHomeSelected() ? "class=\"selected\"" : "" );
      out.write("\r\n\t\t\t\t\tonclick=\"setEvent('");
      out.print( theChip.getEventID(MenuChip.HOME) );
      out.write("'); setScrollAndSubmit(); return false;\"\r\n\t\t\t\t\tonMouseOver=\"window.status='");
      out.print( localized("explorer.link.root") );
      out.write("'; return true;\" onMouseOut=\"window.status=''; return true;\"\r\n\t\t\t\t\thidefocus=\"true\"\r\n\t\t\t\t\tstyle=\"width:30px; white-space:nowrap; padding-right:5px; vertical-align:middle;\"\r\n\t\t\t\t\tid=\"");
      out.print( theChip.getUniqueName() );
      out.write("_username\">\r\n\t\t\t\t\t");
      out.print( theChip.getUserName() );
      out.write("\r\n\t\t\t\t</a>\r\n\t\t\t</td>\r\n\t\t</tr>\r\n");
      ...
      out.print( rootChip.getID() );
      out.write("</div>\r\n\t\t\t\t\t\t\t\t<div class=\"tenantIDStr\">");
      out.print(tenantIDStr);
      out.write("</div>\r\n\t\t\t\t\t\t\t\t<div class=\"icon ");
      out.print( cssClass );
      out.write("\" id=\"");
      out.print( rootChip.getUniqueName() );
      out.write("_treeicon\" onclick=\"\"></div>\t");
      out.write("\r\n\t\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\r\n\t\t\t\t\t\t<div class=\"");
      out.print( it.hasNext() ? "horizontal" : "end" );
      out.write("\"></div>\r\n");
