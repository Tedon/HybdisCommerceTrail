...
public final class genericAtomicTypeListChip_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	*/
	...
	else
	{
      ...
      out.write("\r\n\t\t\t<table class=\"genericAtomicTypeListChip\" style=\"width:");
      out.print( theChip.getWidth() );
      out.write("px;\" cellspacing=\"0\" cellpadding=\"0\" oncontextmenu=\"");
      out.print( contextMenu );
      out.write("\">\r\n\t\t\t\t<tr>\r\n\t\t\t\t\t<td>\r\n\t\t\t\t\t\t<div class=\"gatlcResultList\" id=\"resultlist_");
      ...
      out.print(theChip.getCommandID(GenericListChip.SELECT_VISIBLE));
      out.write("'].value='");
      ...
      out.write("\r\n\t\t\t\t\t\t\t\t\t<th class=\"gatlcEntry\" ");
      out.print( !theChip.isEditable() ? "style=\"border-left:1px solid #bbbbbb;\"" : "" );
      out.write(">\r\n\t\t\t\t\t\t\t\t\t\t<div class=\"gatlcEntry\">\r\n\t\t\t\t\t\t\t\t\t\t\t");
      out.print( localized(theChip.getTitle()) );
      out.write("\r\n\t\t\t\t\t\t\t\t\t\t</div>\r\n\t\t\t\t\t\t\t\t\t</th>\r\n\t\t\t\t\t\t\t\t</tr>\r\n");
      ...
      out.write("\r\n\t\t\t\t\t\t\t\t\t\t<td class=\"gatlcCheckbox\">\r\n\t\t\t\t\t\t\t\t\t\t\t<input onclick=\"document.editorForm.elements['SELECTOR'].checked=false;\" type=\"");
      out.print( ( theChip.isMultipleSelectionAllowed() ? "checkbox" : "radio" ) );
      out.write("\" name=\"");
      out.print(theChip.getEventID(SearchListChip.SELECT));
      out.write("\" value=\"");
      ...
      out.print( ((GenericEditableListEntryChip) chip).getEditorChip().isChanged() ? "*" : "" );
      out.write("\r\n\t\t\t\t\t\t\t\t\t\t\t</div>\r\n\t\t\t\t\t\t\t\t\t\t</td>\r\n");

				}

      out.write("\r\n\t\t\t\t\t\t\t\t\t\t<td style=\"width:");
      out.print( theChip.getWidth() - 50 );
      out.write("px; border-right:1px solid #bbbbbb; ");
      out.print( !theChip.isEditable() ? "border-left:1px solid #bbbbbb;" : "" );
      out.write("\">\r\n\t\t\t\t\t\t\t\t\t\t\t<div style=\"width:");
      out.print( theChip.getWidth() - 50 );
      out.write("px; overflow:hidden;\">\r\n");
      ...
      out.write("\r\n\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t<td style=\"width:20px; border-left:1px solid #bbbbbb;\" ");
      out.print( theChip.isEntriesEditable() ? "colspan=\"2\"" : "");
