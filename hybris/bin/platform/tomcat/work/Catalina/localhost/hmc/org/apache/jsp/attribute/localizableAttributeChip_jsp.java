...
public final class localizableAttributeChip_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	*/
	...
	final boolean isExpanded = theChip.isExpanded() && expandable;
      ...
      out.write("\r\n\r\n<table class=\"localAttributeChip\" ");
      out.print((tooltip!=null?" title=\""+tooltip+"\"":""));
	...
	if( theChip.isAjaxUpdatable() )
	{
      ...
      out.print( theChip.isAjaxUpdatable() ? "language-toggle" : "chip-event" );
      out.write("\" title=\"");
      out.print( isExpanded ? localized("collapse") : localized("expand") );
      out.write("\">\r\n\t\t\t\t<a href=\"#\"\r\n\t\t\t\t\tclass=\"");
      out.print( isExpanded ? "collapse" : "expand" );
      out.write("\" \r\n\t\t\t\t\thidefocus=\"true\" \r\n\t\t\t\t\tid=\"");
      out.print( theChip.getUniqueName() );
      out.write("_languagetoggle\"\r\n\t\t\t\t\thidefocus=\"true\"\r\n\t\t\t\t\tname=\"");
      out.print( theChip.isAjaxUpdatable() ? theChip.getID() : theChip.getCommandID(isExpanded ? LocalizableAttributeChip.COLLAPSE_LOCALIZE : LocalizableAttributeChip.EXPAND_LOCALIZE) );
      out.write("\">\r\n\t\t\t\t\t");
      out.print( theChip.isAjaxUpdatable() ?"<div class=\"tenantIDStr\">"+tenantIDStr+"</div>":"");
      out.write("\r\n\t\t\t\t</a>\r\n\t\t\t</div>\r\n");

		}

      out.write("\r\n\t\t</td>\r\n\r\n\t\t<!-- label -->\r\n\t\t<td class=\"label\" style=\"width:");
      out.print( labelWidth + "px" );
      out.write("\">\r\n\t\t\t<div ");
      out.print((editable ? "" : "class=\"disabled\"") );
      out.write(" style=\"width:");
      out.print( labelWidth + "px" );
      out.write(';');
      out.print( required ? "font-weight:bold;" : "" );
      out.write("\" >\r\n\t\t\t\t");
      out.print( label.length() > 0 ? (label + ":") : "" );
      out.write("\r\n\t\t\t</div>\r\n\t\t</td>\r\n");
      ...
      out.print( "&nbsp;" + localized("attributeerror") +
      ...
      out.write("\r\n\t\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t\t<!-- language code -->\r\n\t\t\t\t\t\t\t\t<td class=\"langCode\">\r\n\t\t\t\t\t\t\t\t\t<div class=\"");
      out.print( (editable ? "edit" : "noedit") );
      out.write("\">\r\n\t\t\t\t\t\t\t\t\t\t");
      out.print( curLanguage.getIsoCode() );
      out.write("&nbsp;\r\n\t\t\t\t\t\t\t\t\t</div>\r\n\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t<!-- is changed sign -->\r\n\t\t\t\t\t\t \t\t<td class=\"isChangedSign\">\r\n\t\t\t\t\t\t \t\t\t<div ");
      out.print( editorChip.isChanged() ? "title=\""+localized("attribute.ischanged.tooltip")+"\"" : "" );
      out.write(">\r\n\t\t\t\t\t\t\t\t\t\t");
      out.print( (editorChip.isChanged() ? "*" : "&nbsp;") );
      out.write("\r\n\t\t\t\t\t\t\t\t\t</div>\r\n\t\t\t\t\t\t \t\t</td>\r\n\t\t\t\t\t\t\t\t<!-- attribute editor -->\r\n\t\t\t\t\t\t\t\t<td>\r\n\t\t\t\t\t\t\t\t\t");
 editorChip.render(pageContext); 
      ...
      out.print( curLanguage.getIsoCode() );
      out.write("&nbsp;\r\n\t\t\t\t\t\t\t\t\t</div>\r\n\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t<!-- is changed sign -->\r\n\t\t\t\t\t\t \t\t<td class=\"isChangedSign\">\r\n\t\t\t\t\t\t \t\t</td>\r\n\t\t\t\t\t\t\t\t<!-- attribute editor -->\r\n\t\t\t\t\t\t\t\t<td class=\"disabled\">\r\n\t\t\t\t\t\t\t\t\t");
      out.print(theChip.getLocalizedString("attribute.localizable.notvisible",curLanguage.getIsoCode()) );
      out.write("\r\n\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t\t");
 ...
 editorChip.render(pageContext); 
      ...
      out.print(expandable?"class=\"button-on-white chip-event\"":"");
      out.write(">\r\n\t\t\t\t\t\t\t\t\t<a href=\"#\" ");
      out.print(expandable?"title=\""+localized("expand")+"\"":"");
      out.write("\r\n\t\t\t\t\t\t\t\t\t\tname=\"");
      out.print( theChip.getCommandID(LocalizableAttributeChip.EXPAND_LOCALIZE) );
      out.write("\"\r\n\t\t\t\t\t\t\t\t\t\thidefocus=\"true\"\r\n\t\t\t\t\t\t\t\t\t\ttabindex=\"100000\"\r\n\t\t\t\t\t\t\t\t\t>\r\n\t\t\t\t\t\t\t\t\t\t<span>\r\n\t\t\t\t\t\t\t\t\t\t\t<img class=\"icon\" src=\"images/icons/button_language.gif\" id=\"");
      out.print( theChip.getUniqueName() );
      out.write("_img\"/>\r\n\t\t\t\t\t\t\t\t\t\t</span>\r\n\t\t\t\t\t\t\t\t\t</a>\r\n\t\t\t\t\t\t\t\t</div>\r\n\t\t\t\t\t\t\t</td>\r\n");
      ...
      out.write("\t\t\t\r\n\t\t\t\t\t\t\t\t<!-- is changed sign -->\r\n\t\t\t\t\t\t \t\t<td class=\"isChangedSign\">\r\n\t\t\t\t\t\t \t\t\t<div ");
      out.print( theChip.isChanged() ? "title=\""+localized("attribute.ischanged.tooltip")+"\"" : "" );
      out.write(">\r\n\t\t\t\t\t\t\t\t\t\t");
      ...
      out.print( theChip.getDescriptionAttributeValue() );
      out.write("\r\n\t\t\t\t</span>\r\n\t\t\t</td>\r\n");
      ...
      out.write("\r\n\t \t\t<td class=\"description\">\r\n\t\t\t\t<span class=\"description\">\r\n\t\t\t \t\t&nbsp;");
      out.print( theChip.getDescription() );
      out.write("\r\n\t\t\t\t</span>\r\n\t\t\t</td>\r\n");
