...
public class SAPInitiativeReaderImpl extends BusinessObjectBase implements SAPInitiativeReader
{
	...
	public List<SAPInitiative> searchInitiativesForBP(final String businessPartner) throws ODataException, URISyntaxException, IOException, RuntimeException
	{
	...
	public SAPInitiative getSelectedInitiative(final String id) throws ODataException, URISyntaxException, IOException, RuntimeException
	{
	...
	public SAPInitiative getInitiative(final String id) throws ODataException, URISyntaxException, IOException, RuntimeException
	{
		final String keyValue = "'" + convertToInternalKey(id) + "'";
