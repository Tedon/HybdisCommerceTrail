						...
						&& (item != null && item.getAttribute(SAPRFCDestinationEvent.RFC_DESTINATION_NAME) != null))
				{
					...
					else
					{
						...
						if (currentValues.containsKey(SAPRFCDestinationEvent.JCO_TRACE_LEVEL)
								|| currentValues.containsKey(SAPRFCDestinationEvent.JCO_TRACE_PATH))
						{
							SAPRFCDestinationJCoTraceEvent event = new SAPRFCDestinationJCoTraceEvent();
							event.setDestinationName(item.getAttribute(SAPRFCDestinationEvent.RFC_DESTINATION_NAME).toString());
