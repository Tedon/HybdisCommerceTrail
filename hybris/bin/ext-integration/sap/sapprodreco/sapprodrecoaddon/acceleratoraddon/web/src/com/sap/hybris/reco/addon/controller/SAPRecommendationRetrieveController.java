...
public class SAPRecommendationRetrieveController
{
	...
	@RequestMapping(value = "/action/recommendations/{recoId}/{title}/{recommendationModel}/{productCode}/{itemType}/{includeCart}")
	public String retrieveRecommentdations(@PathVariable final String recoId, @PathVariable final String title, @PathVariable final String recommendationModel, 
			...
			throws UnsupportedEncodingException
	{
		...
		LOG.debug("Read product recommendations");
		...
		model.addAttribute("recoId", recoId);
