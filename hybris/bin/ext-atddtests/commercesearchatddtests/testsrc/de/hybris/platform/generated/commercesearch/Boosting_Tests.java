	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/rp/tmp/pipelines/20150120055626_commercesearch_artifact_release_5.4.0_eeefd7c749570eea1eb197e5ac67ebb2f7f031f3/prepare/build/source/commercesearchatddtests/genresources/robottests/Boosting_Tests.txt"));
		}
