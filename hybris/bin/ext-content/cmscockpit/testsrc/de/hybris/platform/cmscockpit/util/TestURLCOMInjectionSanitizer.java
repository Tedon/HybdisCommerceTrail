...
public class TestURLCOMInjectionSanitizer extends ServicelayerTest {
    ...
    {
        final String url = CommandInjectionSanitizer.sanitize("http://sensitive/cgi-bin/userData.pl?doc=/bin/ls|");
    ...
    {
        final String url = CommandInjectionSanitizer.sanitize("http://sensitive/cgi-bin/userData.pl?doc=/bin/ls;/bin/ls;");
        System.out.print(url);
        assertThat(StringUtils.contains(url, ";"), is(false));
    ...
    {
        final String url = CommandInjectionSanitizer.sanitize("http://sensitive/cgi-bin/userData.pl?doc=/\"`ls`\"");
        assertThat(StringUtils.contains(url, "\""), is(false));
    ...
    {
        final String url = CommandInjectionSanitizer.sanitize("http://sensitive/cgi-bin/userData.pl?doc=/bin/ls>tom.txt");
        assertThat(StringUtils.contains(url, ">"), is(false));
    ...
    {
        final String url = CommandInjectionSanitizer.sanitize("http://sensitive/cgi-bin/userData.pl?doc=<tom.txt");
        assertThat(StringUtils.contains(url, "<"), is(false));
    ...
    {
        final String url = CommandInjectionSanitizer.sanitize("http://www.domain.com?balh=&;blah=blah");
        assertThat(StringUtils.contains(url, ";"), is(false));
        assertThat(StringUtils.countMatches(url, "&"), is(1));
    }
